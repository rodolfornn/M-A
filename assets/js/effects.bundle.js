...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function Zf(i,e,t){let n=new Float32Array(ci),s=new B(0,1,0);return new kt({name:"SphericalGaussianBlur",defines:{n:ci,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Ua(),fragmentShader:`
...
`)}var $p={[Co]:"Linear",[Ro]:"Reinhard",[Io]:"Cineon",[Po]:"ACESFilmic",[Do]:"AgX",[No]:"Neutral",[Lo]:"Custom"};function Kp(i,e){let t=$p[e];return t===void 0?(Ee("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Pa=new B;function Qp(){Ge.getLuminanceCoefficients(Pa);let i=Pa.x.toFixed(4),e=Pa.y.toFixed(4),t=Pa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+g);let C=b+p+o,M=b+g+u,w=Gc(s,s.VERTEX_SHADER,C),A=Gc(s,s.FRAGMENT_SHADER,M);s.attachShader(x,w),s.attachShader(x,A),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(E){if(i.debug.checkShaderErrors){let P=s.getProgramInfoLog(x)||"",F=s.getShaderInfoLog(w)||"",k=s.getShaderInfoLog(A)||"",U=P.trim(),X=F.trim(),H=k.trim(),J=!0,ee=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,w,A);else{let ie=Wc(s,w,"vertex"),re=Wc(s,A,"fragment");Ie("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+U+`
`+ie+`
`+re)}else U!==""?Ee("WebGLProgram: Program Info Log:",U):(X===""||H==="")&&(ee=!1);ee&&(E.diagnostics={runnable:J,programLog:U,vertexShader:{log:X,prefix:p},fragmentShader:{log:H,prefix:g}})}s.deleteShader(w),s.deleteShader(A),v=new ki(s,x),T=tm(s,x)}let v;this.getUniforms=function(){return v===void 0&&R(this),v};let T;this.getAttributes=function(){return T===void 0&&R(this),T};let L=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return L===!1&&(L=s.getProgramParameter(x,Xp)),L},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=qp++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=w,this.fragmentShader=A,this}var _m=0,al=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){let s=this._getShaderCacheForMaterial(e);return s.has(t)===!1&&(s.add(t),t.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){let t=this.shaderCache,n=t.get(e);return n===void 0&&(n=new ol(e),t.set(e,n)),n}},ol=class{constructor(e){this.id=_m++,this.code=e,this.usedTimes=0}};function xm(i){return i===Yn||i===bs||i===As}function vm(i,e,t,n,s,r){let o=new es,u=new al,h=new Set,d=[],a=new Map,c=n.logarithmicDepthBuffer,l=n.precision,f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function m(v){return h.add(v),v===0?"uv":`uv${v}`}function x(v,T,L,E,P,F){let k=E.fog,U=P.geometry,X=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?E.environment:null,H=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap,J=e.get(v.envMap||X,H),ee=J&&J.mapping===_s?J.image.height:null,ie=f[v.type];v.precision!==null&&(l=n.getMaxPrecision(v.precision),l!==v.precision&&Ee("WebGLProgram.getParameters:",v.precision,"not supported, using",l,"instead."));let re=U.morphAttributes.position||U.morphAttributes.normal||U.morphAttributes.color,se=re!==void 0?re.length:0,Ne=0;U.morphAttributes.position!==void 0&&(Ne=1),U.morphAttributes.normal!==void 0&&(Ne=2),U.morphAttributes.color!==void 0&&(Ne=3);let Oe,De,Z,te;if(ie){let xe=pn[ie];Oe=xe.vertexShader,De=xe.fragmentShader}else{Oe=v.vertexShader,De=v.fragmentShader;let xe=u.getVertexShaderStage(v),ot=u.getFragmentShaderStage(v);u.update(v,xe,ot),Z=xe.id,te=ot.id}let j=i.getRenderTarget(),Te=i.state.buffers.depth.getReversed(),Ce=P.isInstancedMesh===!0,we=P.isBatchedMesh===!0,st=!!v.map,Be=!!v.matcap,qe=!!J,ke=!!v.aoMap,He=!!v.lightMap,tt=!!v.bumpMap&&v.wireframe===!1,ft=!!v.normalMap,gt=!!v.displacementMap,yt=!!v.emissiveMap,at=!!v.metalnessMap,ht=!!v.roughnessMap,D=v.anisotropy>0,Lt=v.clearcoat>0,Je=v.dispersion>0,S=v.iridescence>0,_=v.sheen>0,O=v.transmission>0,G=D&&!!v.anisotropyMap,q=Lt&&!!v.clearcoatMap,ne=Lt&&!!v.clearcoatNormalMap,oe=Lt&&!!v.clearcoatRoughnessMap,Y=S&&!!v.iridescenceMap,K=S&&!!v.iridescenceThicknessMap,le=_&&!!v.sheenColorMap,Me=_&&!!v.sheenRoughnessMap,he=!!v.specularMap,ce=!!v.specularColorMap,Ae=!!v.specularIntensityMap,Re=O&&!!v.transmissionMap,Ue=O&&!!v.thicknessMap,I=!!v.gradientMap,ae=!!v.alphaMap,$=v.alphaTest>0,ue=!!v.alphaHash,me=!!v.extensions,Q=$t;v.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(Q=i.toneMapping);let ye={shaderID:ie,shaderType:v.type,shaderName:v.name,vertexShader:Oe,fragmentShader:De,defines:v.defines,customVertexShaderID:Z,customFragmentShaderID:te,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:l,batching:we,batchingColor:we&&P._colorsTexture!==null,instancing:Ce,instancingColor:Ce&&P.instanceColor!==null,instancingMorph:Ce&&P.morphTexture!==null,outputColorSpace:j===null?i.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:Ge.workingColorSpace,alphaToCoverage:!!v.alphaToCoverage,map:st,matcap:Be,envMap:qe,envMapMode:qe&&J.mapping,envMapCubeUVHeight:ee,aoMap:ke,lightMap:He,bumpMap:tt,normalMap:ft,displacementMap:gt,emissiveMap:yt,normalMapObjectSpace:ft&&v.normalMapType===_c,normalMapTangentSpace:ft&&v.normalMapType===wa,packedNormalMap:ft&&v.normalMapType===wa&&xm(v.normalMap.format),metalnessMap:at,roughnessMap:ht,anisotropy:D,anisotropyMap:G,clearcoat:Lt,clearcoatMap:q,clearcoatNormalMap:ne,clearcoatRoughnessMap:oe,dispersion:Je,iridescence:S,iridescenceMap:Y,iridescenceThicknessMap:K,sheen:_,sheenColorMap:le,sheenRoughnessMap:Me,specularMap:he,specularColorMap:ce,specularIntensityMap:Ae,transmission:O,transmissionMap:Re,thicknessMap:Ue,gradientMap:I,opaque:v.transparent===!1&&v.blending===ni&&v.alphaToCoverage===!1,alphaMap:ae,alphaTest:$,alphaHash:ue,combine:v.combine,mapUv:st&&m(v.map.channel),aoMapUv:ke&&m(v.aoMap.channel),lightMapUv:He&&m(v.lightMap.channel),bumpMapUv:tt&&m(v.bumpMap.channel),normalMapUv:ft&&m(v.normalMap.channel),displacementMapUv:gt&&m(v.displacementMap.channel),emissiveMapUv:yt&&m(v.emissiveMap.channel),metalnessMapUv:at&&m(v.metalnessMap.channel),roughnessMapUv:ht&&m(v.roughnessMap.channel),anisotropyMapUv:G&&m(v.anisotropyMap.channel),clearcoatMapUv:q&&m(v.clearcoatMap.channel),clearcoatNormalMapUv:ne&&m(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:oe&&m(v.clearcoatRoughnessMap.channel),iridescenceMapUv:Y&&m(v.iridescenceMap.channel),iridescenceThicknessMapUv:K&&m(v.iridescenceThicknessMap.channel),sheenColorMapUv:le&&m(v.sheenColorMap.channel),sheenRoughnessMapUv:Me&&m(v.sheenRoughnessMap.channel),specularMapUv:he&&m(v.specularMap.channel),specularColorMapUv:ce&&m(v.specularColorMap.channel),specularIntensityMapUv:Ae&&m(v.specularIntensityMap.channel),transmissionMapUv:Re&&m(v.transmissionMap.channel),thicknessMapUv:Ue&&m(v.thicknessMap.channel),alphaMapUv:ae&&m(v.alphaMap.channel),vertexTangents:!!U.attributes.tangent&&(ft||D),vertexNormals:!!U.attributes.normal,vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!U.attributes.color&&U.attributes.color.itemSize===4,pointsUvs:P.isPoints===!0&&!!U.attributes.uv&&(st||ae),fog:!!k,useFog:v.fog===!0,fogExp2:!!k&&k.isFogExp2,flatShading:v.wireframe===!1&&(v.flatShading===!0||U.attributes.normal===void 0&&ft===!1&&(v.isMeshLambertMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isMeshPhysicalMaterial)),sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:c,reversedDepthBuffer:Te,skinning:P.isSkinnedMesh===!0,hasPositionAttribute:U.attributes.position!==void 0,morphTargets:U.morphAttributes.position!==void 0,morphNormals:U.morphAttributes.normal!==void 0,morphColors:U.morphAttributes.color!==void 0,morphTargetsCount:se,morphTextureStride:Ne,numDirLights:T.directional.length,numPointLights:T.point.length,numSpotLights:T.spot.length,numSpotLightMaps:T.spotLightMap.length,numRectAreaLights:T.rectArea.length,numHemiLights:T.hemi.length,numDirLightShadows:T.directionalShadowMap.length,numPointLightShadows:T.pointShadowMap.length,numSpotLightShadows:T.spotShadowMap.length,numSpotLightShadowsWithMaps:T.numSpotLightShadowsWithMaps,numLightProbes:T.numLightProbes,numLightProbeGrids:F.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:v.dithering,shadowMapEnabled:i.shadowMap.enabled&&L.length>0,shadowMapType:i.shadowMap.type,toneMapping:Q,decodeVideoTexture:st&&v.map.isVideoTexture===!0&&Ge.getTransfer(v.map.colorSpace)===Ze,decodeVideoTextureEmissive:yt&&v.emissiveMap.isVideoTexture===!0&&Ge.getTransfer(v.emissiveMap.colorSpace)===Ze,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===un,flipSided:v.side===Pt,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:me&&v.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(me&&v.extensions.multiDraw===!0||we)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return ye.vertexUv1s=h.has(1),ye.vertexUv2s=h.has(2),ye.vertexUv3s=h.has(3),h.clear(),ye}function p(v){let T=[];if(v.shaderID?T.push(v.shaderID):(T.push(v.customVertexShaderID),T.push(v.customFragmentShaderID)),v.defines!==void 0)for(let L in v.defines)T.push(L),T.push(v.defines[L]);return v.isRawShaderMaterial===!1&&(g(T,v),b(T,v),T.push(i.outputColorSpace)),T.push(v.customProgramCacheKey),T.join()}function g(v,T){v.push(T.precision),v.push(T.outputColorSpace),v.push(T.envMapMode),v.push(T.envMapCubeUVHeight),v.push(T.mapUv),v.push(T.alphaMapUv),v.push(T.lightMapUv),v.push(T.aoMapUv),v.push(T.bumpMapUv),v.push(T.normalMapUv),v.push(T.displacementMapUv),v.push(T.emissiveMapUv),v.push(T.metalnessMapUv),v.push(T.roughnessMapUv),v.push(T.anisotropyMapUv),v.push(T.clearcoatMapUv),v.push(T.clearcoatNormalMapUv),v.push(T.clearcoatRoughnessMapUv),v.push(T.iridescenceMapUv),v.push(T.iridescenceThicknessMapUv),v.push(T.sheenColorMapUv),v.push(T.sheenRoughnessMapUv),v.push(T.specularMapUv),v.push(T.specularColorMapUv),v.push(T.specularIntensityMapUv),v.push(T.transmissionMapUv),v.push(T.thicknessMapUv),v.push(T.combine),v.push(T.fogExp2),v.push(T.sizeAttenuation),v.push(T.morphTargetsCount),v.push(T.morphAttributeCount),v.push(T.numDirLights),v.push(T.numPointLights),v.push(T.numSpotLights),v.push(T.numSpotLightMaps),v.push(T.numHemiLights),v.push(T.numRectAreaLights),v.push(T.numDirLightShadows),v.push(T.numPointLightShadows),v.push(T.numSpotLightShadows),v.push(T.numSpotLightShadowsWithMaps),v.push(T.numLightProbes),v.push(T.shadowMapType),v.push(T.toneMapping),v.push(T.numClippingPlanes),v.push(T.numClipIntersection),v.push(T.depthPacking)}function b(v,T){o.disableAll(),T.instancing&&o.enable(0),T.instancingColor&&o.enable(1),T.instancingMorph&&o.enable(2),T.matcap&&o.enable(3),T.envMap&&o.enable(4),T.normalMapObjectSpace&&o.enable(5),T.normalMapTangentSpace&&o.enable(6),T.clearcoat&&o.enable(7),T.iridescence&&o.enable(8),T.alphaTest&&o.enable(9),T.vertexColors&&o.enable(10),T.vertexAlphas&&o.enable(11),T.vertexUv1s&&o.enable(12),T.vertexUv2s&&o.enable(13),T.vertexUv3s&&o.enable(14),T.vertexTangents&&o.enable(15),T.anisotropy&&o.enable(16),T.alphaHash&&o.enable(17),T.batching&&o.enable(18),T.dispersion&&o.enable(19),T.batchingColor&&o.enable(20),T.gradientMap&&o.enable(21),T.packedNormalMap&&o.enable(22),T.vertexNormals&&o.enable(23),v.push(o.mask),o.disableAll(),T.fog&&o.enable(0),T.useFog&&o.enable(1),T.flatShading&&o.enable(2),T.logarithmicDepthBuffer&&o.enable(3),T.reversedDepthBuffer&&o.enable(4),T.skinning&&o.enable(5),T.morphTargets&&o.enable(6),T.morphNormals&&o.enable(7),T.morphColors&&o.enable(8),T.premultipliedAlpha&&o.enable(9),T.shadowMapEnabled&&o.enable(10),T.doubleSided&&o.enable(11),T.flipSided&&o.enable(12),T.useDepthPacking&&o.enable(13),T.dithering&&o.enable(14),T.transmission&&o.enable(15),T.sheen&&o.enable(16),T.opaque&&o.enable(17),T.pointsUvs&&o.enable(18),T.decodeVideoTexture&&o.enable(19),T.decodeVideoTextureEmissive&&o.enable(20),T.alphaToCoverage&&o.enable(21),T.numLightProbeGrids>0&&o.enable(22),T.hasPositionAttribute&&o.enable(23),v.push(o.mask)}function C(v){let T=f[v.type],L;if(T){let E=pn[T];L=Rc.clone(E.uniforms)}else L=v.uniforms;return L}function M(v,T){let L=a.get(T);return L!==void 0?++L.usedTimes:(L=new gm(i,T,v,s),d.push(L),a.set(T,L)),L}function w(v){if(--v.usedTimes===0){let T=d.indexOf(v);d[T]=d[d.length-1],d.pop(),a.delete(v.cacheKey),v.destroy()}}function A(v){u.remove(v)}function R(){u.dispose()}return{getParameters:x,getProgramCacheKey:p,getUniforms:C,acquireProgram:M,releaseProgram:w,releaseShaderCache:A,programs:d,dispose:R}}function ym(){let i=new WeakMap;function e(o){return i.has(o)}function t(o){let u=i.get(o);return u===void 0&&(u={},i.set(o,u)),u}function n(o){i.delete(o)}function s(o,u,h){i.get(o)[u]=h}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function Mm(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function Jc(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function $c(){let i=[],e=0,t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function o(l){let f=0;return l.isInstancedMesh&&(f+=2),l.isSkinnedMesh&&(f+=1),f}function u(l,f,m,x,p,g){let b=i[e];return b===void 0?(b={id:l.id,object:l,geometry:f,material:m,materialVariant:o(l),groupOrder:x,renderOrder:l.renderOrder,z:p,group:g},i[e]=b):(b.id=l.id,b.object=l,b.geometry=f,b.material=m,b.materialVariant=o(l),b.groupOrder=x,b.renderOrder=l.renderOrder,b.z=p,b.group=g),e++,b}function h(l,f,m,x,p,g){let b=u(l,f,m,x,p,g);m.transmission>0?n.push(b):m.transparent===!0?s.push(b):t.push(b)}function d(l,f,m,x,p,g){let b=u(l,f,m,x,p,g);m.transmission>0?n.unshift(b):m.transparent===!0?s.unshift(b):t.unshift(b)}function a(l,f,m){t.length>1&&t.sort(l||Mm),n.length>1&&n.sort(f||Jc),s.length>1&&s.sort(f||Jc),m&&(t.reverse(),n.reverse(),s.reverse())}function c(){for(let l=e,f=i.length;l<f;l++){let m=i[l];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:h,unshift:d,finish:c,sort:a}}function Sm(){let i=new WeakMap;function e(n,s){let r=i.get(n),o;return r===void 0?(o=new $c,i.set(n,[o])):s>=r.length?(o=new $c,r.push(o)):o=r[s],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function bm(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new B,color:new Le};break;case"SpotLight":t={position:new B,direction:new B,color:new Le,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new B,color:new Le,distance:0,decay:0};break;case"HemisphereLight":t={direction:new B,skyColor:new Le,groundColor:new Le};break;case"RectAreaLight":t={color:new Le,position:new B,halfWidth:new B,halfHeight:new B};break}return i[e.id]=t,t}}}function Am(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Xe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Xe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Xe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}var Tm=0;function Em(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function wm(i){let e=new bm,t=Am(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let d=0;d<9;d++)n.probe.push(new B);let s=new B,r=new it,o=new it;function u(d){let a=0,c=0,l=0;for(let T=0;T<9;T++)n.probe[T].set(0,0,0);let f=0,m=0,x=0,p=0,g=0,b=0,C=0,M=0,w=0,A=0,R=0;d.sort(Em);for(let T=0,L=d.length;T<L;T++){let E=d[T],P=E.color,F=E.intensity,k=E.distance,U=null;if(E.shadow&&E.shadow.map&&(E.shadow.map.texture.format===Yn?U=E.shadow.map.texture:U=E.shadow.map.depthTexture||E.shadow.map.texture),E.isAmbientLight)a+=P.r*F,c+=P.g*F,l+=P.b*F;else if(E.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(E.sh.coefficients[X],F);R++}else if(E.isDirectionalLight){let X=e.get(E);if(X.color.copy(E.color).multiplyScalar(E.intensity),E.castShadow){let H=E.shadow,J=t.get(E);J.shadowIntensity=H.intensity,J.shadowBias=H.bias,J.shadowNormalBias=H.normalBias,J.shadowRadius=H.radius,J.shadowMapSize=H.mapSize,n.directionalShadow[f]=J,n.directionalShadowMap[f]=U,n.directionalShadowMatrix[f]=E.shadow.matrix,b++}n.directional[f]=X,f++}else if(E.isSpotLight){let X=e.get(E);X.position.setFromMatrixPosition(E.matrixWorld),X.color.copy(P).multiplyScalar(F),X.distance=k,X.coneCos=Math.cos(E.angle),X.penumbraCos=Math.cos(E.angle*(1-E.penumbra)),X.decay=E.decay,n.spot[x]=X;let H=E.shadow;if(E.map&&(n.spotLightMap[w]=E.map,w++,H.updateMatrices(E),E.castShadow&&A++),n.spotLightMatrix[x]=H.matrix,E.castShadow){let J=t.get(E);J.shadowIntensity=H.intensity,J.shadowBias=H.bias,J.shadowNormalBias=H.normalBias,J.shadowRadius=H.radius,J.shadowMapSize=H.mapSize,n.spotShadow[x]=J,n.spotShadowMap[x]=U,M++}x++}else if(E.isRectAreaLight){let X=e.get(E);X.color.copy(P).multiplyScalar(F),X.halfWidth.set(E.width*.5,0,0),X.halfHeight.set(0,E.height*.5,0),n.rectArea[p]=X,p++}else if(E.isPointLight){let X=e.get(E);if(X.color.copy(E.color).multiplyScalar(E.intensity),X.distance=E.distance,X.decay=E.decay,E.castShadow){let H=E.shadow,J=t.get(E);J.shadowIntensity=H.intensity,J.shadowBias=H.bias,J.shadowNormalBias=H.normalBias,J.shadowRadius=H.radius,J.shadowMapSize=H.mapSize,J.shadowCameraNear=H.camera.near,J.shadowCameraFar=H.camera.far,n.pointShadow[m]=J,n.pointShadowMap[m]=U,n.pointShadowMatrix[m]=E.shadow.matrix,C++}n.point[m]=X,m++}else if(E.isHemisphereLight){let X=e.get(E);X.skyColor.copy(E.color).multiplyScalar(F),X.groundColor.copy(E.groundColor).multiplyScalar(F),n.hemi[g]=X,g++}}p>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=de.LTC_FLOAT_1,n.rectAreaLTC2=de.LTC_FLOAT_2):(n.rectAreaLTC1=de.LTC_HALF_1,n.rectAreaLTC2=de.LTC_HALF_2)),n.ambient[0]=a,n.ambient[1]=c,n.ambient[2]=l;let v=n.hash;(v.directionalLength!==f||v.pointLength!==m||v.spotLength!==x||v.rectAreaLength!==p||v.hemiLength!==g||v.numDirectionalShadows!==b||v.numPointShadows!==C||v.numSpotShadows!==M||v.numSpotMaps!==w||v.numLightProbes!==R)&&(n.directional.length=f,n.spot.length=x,n.rectArea.length=p,n.point.length=m,n.hemi.length=g,n.directionalShadow.length=b,n.directionalShadowMap.length=b,n.pointShadow.length=C,n.pointShadowMap.length=C,n.spotShadow.length=M,n.spotShadowMap.length=M,n.directionalShadowMatrix.length=b,n.pointShadowMatrix.length=C,n.spotLightMatrix.length=M+w-A,n.spotLightMap.length=w,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=R,v.directionalLength=f,v.pointLength=m,v.spotLength=x,v.rectAreaLength=p,v.hemiLength=g,v.numDirectionalShadows=b,v.numPointShadows=C,v.numSpotShadows=M,v.numSpotMaps=w,v.numLightProbes=R,n.version=Tm++)}function h(d,a){let c=0,l=0,f=0,m=0,x=0,p=a.matrixWorldInverse;for(let g=0,b=d.length;g<b;g++){let C=d[g];if(C.isDirectionalLight){let M=n.directional[c];M.direction.setFromMatrixPosition(C.matrixWorld),s.setFromMatrixPosition(C.target.matrixWorld),M.direction.sub(s),M.direction.transformDirection(p),c++}else if(C.isSpotLight){let M=n.spot[f];M.position.setFromMatrixPosition(C.matrixWorld),M.position.applyMatrix4(p),M.direction.setFromMatrixPosition(C.matrixWorld),s.setFromMatrixPosition(C.target.matrixWorld),M.direction.sub(s),M.direction.transformDirection(p),f++}else if(C.isRectAreaLight){let M=n.rectArea[m];M.position.setFromMatrixPosition(C.matrixWorld),M.position.applyMatrix4(p),o.identity(),r.copy(C.matrixWorld),r.premultiply(p),o.extractRotation(r),M.halfWidth.set(C.width*.5,0,0),M.halfHeight.set(0,C.height*.5,0),M.halfWidth.applyMatrix4(o),M.halfHeight.applyMatrix4(o),m++}else if(C.isPointLight){let M=n.point[l];M.position.setFromMatrixPosition(C.matrixWorld),M.position.applyMatrix4(p),l++}else if(C.isHemisphereLight){let M=n.hemi[x];M.direction.setFromMatrixPosition(C.matrixWorld),M.direction.transformDirection(p),x++}}}return{setup:u,setupView:h,state:n}}function Kc(i){let e=new wm(i),t=[],n=[],s=[];function r(l){c.camera=l,t.length=0,n.length=0,s.length=0}function o(l){t.push(l)}function u(l){n.push(l)}function h(l){s.push(l)}function d(){e.setup(t)}function a(l){e.setupView(t,l)}let c={lightsArray:t,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:c,setupLights:d,setupLightsView:a,pushLight:o,pushShadow:u,pushLightProbeGrid:h}}function Cm(i){let e=new WeakMap;function t(s,r=0){let o=e.get(s),u;return o===void 0?(u=new Kc(i),e.set(s,[u])):r>=o.length?(u=new Kc(i),o.push(u)):u=o[r],u}function n(){e=new WeakMap}return{get:t,dispose:n}}var Rm=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,Pm=[new B(1,0,0),new B(-1,0,0),new B(0,1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1)],Lm=[new B(0,-1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1),new B(0,-1,0),new B(0,-1,0)],Qc=new it,ws=new B,el=new B;function Dm(i,e,t){let n=new Ii,s=new Xe,r=new Xe,o=new rt,u=new wr,h=new Cr,d={},a=t.maxTextureSize,c={[bn]:Pt,[Pt]:bn,[un]:un},l=new kt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Xe},radius:{value:4}},vertexShader:Rm,fragmentShader:Im}),f=l.clone();f.defines.HORIZONTAL_PASS=1;let m=new vt;m.setAttribute("position",new St(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new It(m,l),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=gs;let g=this.type;this.render=function(A,R,v){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;this.type===Zl&&(Ee("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=gs);let T=i.getRenderTarget(),L=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),P=i.state;P.setBlending(hn),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);let F=g!==this.type;F&&R.traverse(function(k){k.material&&(Array.isArray(k.material)?k.material.forEach(U=>U.needsUpdate=!0):k.material.needsUpdate=!0)});for(let k=0,U=A.length;k<U;k++){let X=A[k],H=X.shadow;if(H===void 0){Ee("WebGLShadowMap:",X,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);let J=H.getFrameExtents();s.multiply(J),r.copy(H.mapSize),(s.x>a||s.y>a)&&(s.x>a&&(r.x=Math.floor(a/J.x),s.x=r.x*J.x,H.mapSize.x=r.x),s.y>a&&(r.y=Math.floor(a/J.y),s.y=r.y*J.y,H.mapSize.y=r.y));let ee=i.state.buffers.depth.getReversed();if(H.camera._reversedDepth=ee,H.map===null||F===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===Fi){if(X.isPointLight){Ee("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new Vt(s.x,s.y,{format:Yn,type:dn,minFilter:At,magFilter:At,generateMipmaps:!1}),H.map.texture.name=X.name+".shadowMap",H.map.depthTexture=new Tn(s.x,s.y,Qt),H.map.depthTexture.name=X.name+".shadowMapDepth",H.map.depthTexture.format=an,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=xt,H.map.depthTexture.magFilter=xt}else X.isPointLight?(H.map=new Da(s.x),H.map.depthTexture=new Tr(s.x,Kt)):(H.map=new Vt(s.x,s.y),H.map.depthTexture=new Tn(s.x,s.y,Kt)),H.map.depthTexture.name=X.name+".shadowMap",H.map.depthTexture.format=an,this.type===gs?(H.map.depthTexture.compareFunction=ee?Ra:Ca,H.map.depthTexture.minFilter=At,H.map.depthTexture.magFilter=At):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=xt,H.map.depthTexture.magFilter=xt);H.camera.updateProjectionMatrix()}let ie=H.map.isWebGLCubeRenderTarget?6:1;for(let re=0;re<ie;re++){if(H.map.isWebGLCubeRenderTarget)i.setRenderTarget(H.map,re),i.clear();else{re===0&&(i.setRenderTarget(H.map),i.clear());let se=H.getViewport(re);o.set(r.x*se.x,r.y*se.y,r.x*se.z,r.y*se.w),P.viewport(o)}if(X.isPointLight){let se=H.camera,Ne=H.matrix,Oe=X.distance||se.far;Oe!==se.far&&(se.far=Oe,se.updateProjectionMatrix()),ws.setFromMatrixPosition(X.matrixWorld),se.position.copy(ws),el.copy(se.position),el.add(Pm[re]),se.up.copy(Lm[re]),se.lookAt(el),se.updateMatrixWorld(),Ne.makeTranslation(-ws.x,-ws.y,-ws.z),Qc.multiplyMatrices(se.projectionMatrix,se.matrixWorldInverse),H._frustum.setFromProjectionMatrix(Qc,se.coordinateSystem,se.reversedDepth)}else H.updateMatrices(X);n=H.getFrustum(),M(R,v,H.camera,X,this.type)}H.isPointLightShadow!==!0&&this.type===Fi&&b(H,v),H.needsUpdate=!1}g=this.type,p.needsUpdate=!1,i.setRenderTarget(T,L,E)};function b(A,R){let v=e.update(x);l.defines.VSM_SAMPLES!==A.blurSamples&&(l.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,l.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Vt(s.x,s.y,{format:Yn,type:dn})),l.uniforms.shadow_pass.value=A.map.depthTexture,l.uniforms.resolution.value=A.mapSize,l.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(R,null,v,l,x,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(R,null,v,f,x,null)}function C(A,R,v,T){let L=null,E=v.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(E!==void 0)L=E;else if(L=v.isPointLight===!0?h:u,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){let P=L.uuid,F=R.uuid,k=d[P];k===void 0&&(k={},d[P]=k);let U=k[F];U===void 0&&(U=L.clone(),k[F]=U,R.addEventListener("dispose",w)),L=U}if(L.visible=R.visible,L.wireframe=R.wireframe,T===Fi?L.side=R.shadowSide!==null?R.shadowSide:R.side:L.side=R.shadowSide!==null?R.shadowSide:c[R.side],L.alphaMap=R.alphaMap,L.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,L.map=R.map,L.clipShadows=R.clipShadows,L.clippingPlanes=R.clippingPlanes,L.clipIntersection=R.clipIntersection,L.displacementMap=R.displacementMap,L.displacementScale=R.displacementScale,L.displacementBias=R.displacementBias,L.wireframeLinewidth=R.wireframeLinewidth,L.linewidth=R.linewidth,v.isPointLight===!0&&L.isMeshDistanceMaterial===!0){let P=i.properties.get(L);P.light=v}return L}function M(A,R,v,T,L){if(A.visible===!1)return;if(A.layers.test(R.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&L===Fi)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,A.matrixWorld);let F=e.update(A),k=A.material;if(Array.isArray(k)){let U=F.groups;for(let X=0,H=U.length;X<H;X++){let J=U[X],ee=k[J.materialIndex];if(ee&&ee.visible){let ie=C(A,ee,T,L);A.onBeforeShadow(i,A,R,v,F,ie,J),i.renderBufferDirect(v,null,F,ie,A,J),A.onAfterShadow(i,A,R,v,F,ie,J)}}}else if(k.visible){let U=C(A,k,T,L);A.onBeforeShadow(i,A,R,v,F,U,null),i.renderBufferDirect(v,null,F,U,A,null),A.onAfterShadow(i,A,R,v,F,U,null)}}let P=A.children;for(let F=0,k=P.length;F<k;F++)M(P[F],R,v,T,L)}function w(A){A.target.removeEventListener("dispose",w);for(let v in d){let T=d[v],L=A.target.uuid;L in T&&(T[L].dispose(),delete T[L])}}}function Nm(i,e){function t(){let I=!1,ae=new rt,$=null,ue=new rt(0,0,0,0);return{setMask:function(me){$!==me&&!I&&(i.colorMask(me,me,me,me),$=me)},setLocked:function(me){I=me},setClear:function(me,Q,ye,xe,ot){ot===!0&&(me*=xe,Q*=xe,ye*=xe),ae.set(me,Q,ye,xe),ue.equals(ae)===!1&&(i.clearColor(me,Q,ye,xe),ue.copy(ae))},reset:function(){I=!1,$=null,ue.set(-1,0,0,0)}}}function n(){let I=!1,ae=!1,$=null,ue=null,me=null;return{setReversed:function(Q){if(ae!==Q){let ye=e.get("EXT_clip_control");Q?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),ae=Q;let xe=me;me=null,this.setClear(xe)}},getReversed:function(){return ae},setTest:function(Q){Q?j(i.DEPTH_TEST):Te(i.DEPTH_TEST)},setMask:function(Q){$!==Q&&!I&&(i.depthMask(Q),$=Q)},setFunc:function(Q){if(ae&&(Q=wc[Q]),ue!==Q){switch(Q){case lr:i.depthFunc(i.NEVER);break;case cr:i.depthFunc(i.ALWAYS);break;case ur:i.depthFunc(i.LESS);break;case ii:i.depthFunc(i.LEQUAL);break;case hr:i.depthFunc(i.EQUAL);break;case dr:i.depthFunc(i.GEQUAL);break;case fr:i.depthFunc(i.GREATER);break;case pr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ue=Q}},setLocked:function(Q){I=Q},setClear:function(Q){me!==Q&&(me=Q,ae&&(Q=1-Q),i.clearDepth(Q))},reset:function(){I=!1,$=null,ue=null,me=null,ae=!1}}}function s(){let I=!1,ae=null,$=null,ue=null,me=null,Q=null,ye=null,xe=null,ot=null;return{setTest:function(je){I||(je?j(i.STENCIL_TEST):Te(i.STENCIL_TEST))},setMask:function(je){ae!==je&&!I&&(i.stencilMask(je),ae=je)},setFunc:function(je,jt,en){($!==je||ue!==jt||me!==en)&&(i.stencilFunc(je,jt,en),$=je,ue=jt,me=en)},setOp:function(je,jt,en){(Q!==je||ye!==jt||xe!==en)&&(i.stencilOp(je,jt,en),Q=je,ye=jt,xe=en)},setLocked:function(je){I=je},setClear:function(je){ot!==je&&(i.clearStencil(je),ot=je)},reset:function(){I=!1,ae=null,$=null,ue=null,me=null,Q=null,ye=null,xe=null,ot=null}}}let r=new t,o=new n,u=new s,h=new WeakMap,d=new WeakMap,a={},c={},l={},f=new WeakMap,m=[],x=null,p=!1,g=null,b=null,C=null,M=null,w=null,A=null,R=null,v=new Le(0,0,0),T=0,L=!1,E=null,P=null,F=null,k=null,U=null,X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),H=!1,J=0,ee=i.getParameter(i.VERSION);ee.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(ee)[1]),H=J>=1):ee.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(ee)[1]),H=J>=2);let ie=null,re={},se=i.getParameter(i.SCISSOR_BOX),Ne=i.getParameter(i.VIEWPORT),Oe=new rt().fromArray(se),De=new rt().fromArray(Ne);function Z(I,ae,$,ue){let me=new Uint8Array(4),Q=i.createTexture();i.bindTexture(I,Q),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ye=0;ye<$;ye++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(ae,0,i.RGBA,1,1,ue,0,i.RGBA,i.UNSIGNED_BYTE,me):i.texImage2D(ae+ye,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,me);return Q}let te={};te[i.TEXTURE_2D]=Z(i.TEXTURE_2D,i.TEXTURE_2D,1),te[i.TEXTURE_CUBE_MAP]=Z(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),te[i.TEXTURE_2D_ARRAY]=Z(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),te[i.TEXTURE_3D]=Z(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),u.setClear(0),j(i.DEPTH_TEST),o.setFunc(ii),tt(!1),ft(Ao),j(i.CULL_FACE),ke(hn);function j(I){a[I]!==!0&&(i.enable(I),a[I]=!0)}function Te(I){a[I]!==!1&&(i.disable(I),a[I]=!1)}function Ce(I,ae){return l[I]!==ae?(i.bindFramebuffer(I,ae),l[I]=ae,I===i.DRAW_FRAMEBUFFER&&(l[i.FRAMEBUFFER]=ae),I===i.FRAMEBUFFER&&(l[i.DRAW_FRAMEBUFFER]=ae),!0):!1}function we(I,ae){let $=m,ue=!1;if(I){$=f.get(ae),$===void 0&&($=[],f.set(ae,$));let me=I.textures;if($.length!==me.length||$[0]!==i.COLOR_ATTACHMENT0){for(let Q=0,ye=me.length;Q<ye;Q++)$[Q]=i.COLOR_ATTACHMENT0+Q;$.length=me.length,ue=!0}}else $[0]!==i.BACK&&($[0]=i.BACK,ue=!0);ue&&i.drawBuffers($)}function st(I){return x!==I?(i.useProgram(I),x=I,!0):!1}let Be={[Fn]:i.FUNC_ADD,[$l]:i.FUNC_SUBTRACT,[Kl]:i.FUNC_REVERSE_SUBTRACT};Be[Ql]=i.MIN,Be[jl]=i.MAX;let qe={[ec]:i.ZERO,[tc]:i.ONE,[nc]:i.SRC_COLOR,[ar]:i.SRC_ALPHA,[lc]:i.SRC_ALPHA_SATURATE,[ac]:i.DST_COLOR,[sc]:i.DST_ALPHA,[ic]:i.ONE_MINUS_SRC_COLOR,[or]:i.ONE_MINUS_SRC_ALPHA,[oc]:i.ONE_MINUS_DST_COLOR,[rc]:i.ONE_MINUS_DST_ALPHA,[cc]:i.CONSTANT_COLOR,[uc]:i.ONE_MINUS_CONSTANT_COLOR,[hc]:i.CONSTANT_ALPHA,[dc]:i.ONE_MINUS_CONSTANT_ALPHA};function ke(I,ae,$,ue,me,Q,ye,xe,ot,je){if(I===hn){p===!0&&(Te(i.BLEND),p=!1);return}if(p===!1&&(j(i.BLEND),p=!0),I!==Jl){if(I!==g||je!==L){if((b!==Fn||w!==Fn)&&(i.blendEquation(i.FUNC_ADD),b=Fn,w=Fn),je)switch(I){case ni:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Oi:i.blendFunc(i.ONE,i.ONE);break;case To:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Eo:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ie("WebGLState: Invalid blending: ",I);break}else switch(I){case ni:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Oi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case To:Ie("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Eo:Ie("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ie("WebGLState: Invalid blending: ",I);break}C=null,M=null,A=null,R=null,v.set(0,0,0),T=0,g=I,L=je}return}me=me||ae,Q=Q||$,ye=ye||ue,(ae!==b||me!==w)&&(i.blendEquationSeparate(Be[ae],Be[me]),b=ae,w=me),($!==C||ue!==M||Q!==A||ye!==R)&&(i.blendFuncSeparate(qe[$],qe[ue],qe[Q],qe[ye]),C=$,M=ue,A=Q,R=ye),(xe.equals(v)===!1||ot!==T)&&(i.blendColor(xe.r,xe.g,xe.b,ot),v.copy(xe),T=ot),g=I,L=!1}function He(I,ae){I.side===un?Te(i.CULL_FACE):j(i.CULL_FACE);let $=I.side===Pt;ae&&($=!$),tt($),I.blending===ni&&I.transparent===!1?ke(hn):ke(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),o.setFunc(I.depthFunc),o.setTest(I.depthTest),o.setMask(I.depthWrite),r.setMask(I.colorWrite);let ue=I.stencilWrite;u.setTest(ue),ue&&(u.setMask(I.stencilWriteMask),u.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),u.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),yt(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?j(i.SAMPLE_ALPHA_TO_COVERAGE):Te(i.SAMPLE_ALPHA_TO_COVERAGE)}function tt(I){E!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),E=I)}function ft(I){I!==ql?(j(i.CULL_FACE),I!==P&&(I===Ao?i.cullFace(i.BACK):I===Yl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Te(i.CULL_FACE),P=I}function gt(I){I!==F&&(H&&i.lineWidth(I),F=I)}function yt(I,ae,$){I?(j(i.POLYGON_OFFSET_FILL),(k!==ae||U!==$)&&(k=ae,U=$,o.getReversed()&&(ae=-ae),i.polygonOffset(ae,$))):Te(i.POLYGON_OFFSET_FILL)}function at(I){I?j(i.SCISSOR_TEST):Te(i.SCISSOR_TEST)}function ht(I){I===void 0&&(I=i.TEXTURE0+X-1),ie!==I&&(i.activeTexture(I),ie=I)}function D(I,ae,$){$===void 0&&(ie===null?$=i.TEXTURE0+X-1:$=ie);let ue=re[$];ue===void 0&&(ue={type:void 0,texture:void 0},re[$]=ue),(ue.type!==I||ue.texture!==ae)&&(ie!==$&&(i.activeTexture($),ie=$),i.bindTexture(I,ae||te[I]),ue.type=I,ue.texture=ae)}function Lt(){let I=re[ie];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function Je(){try{i.compressedTexImage2D(...arguments)}catch(I){Ie("WebGLState:",I)}}function S(){try{i.compressedTexImage3D(...arguments)}catch(I){Ie("WebGLState:",I)}}function _(){try{i.texSubImage2D(...arguments)}catch(I){Ie("WebGLState:",I)}}function O(){try{i.texSubImage3D(...arguments)}catch(I){Ie("WebGLState:",I)}}function G(){try{i.compressedTexSubImage2D(...arguments)}catch(I){Ie("WebGLState:",I)}}function q(){try{i.compressedTexSubImage3D(...arguments)}catch(I){Ie("WebGLState:",I)}}function ne(){try{i.texStorage2D(...arguments)}catch(I){Ie("WebGLState:",I)}}function oe(){try{i.texStorage3D(...arguments)}catch(I){Ie("WebGLState:",I)}}function Y(){try{i.texImage2D(...arguments)}catch(I){Ie("WebGLState:",I)}}function K(){try{i.texImage3D(...arguments)}catch(I){Ie("WebGLState:",I)}}function le(I){return c[I]!==void 0?c[I]:i.getParameter(I)}function Me(I,ae){c[I]!==ae&&(i.pixelStorei(I,ae),c[I]=ae)}function he(I){Oe.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),Oe.copy(I))}function ce(I){De.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),De.copy(I))}function Ae(I,ae){let $=d.get(ae);$===void 0&&($=new WeakMap,d.set(ae,$));let ue=$.get(I);ue===void 0&&(ue=i.getUniformBlockIndex(ae,I.name),$.set(I,ue))}function Re(I,ae){let ue=d.get(ae).get(I);h.get(ae)!==ue&&(i.uniformBlockBinding(ae,ue,I.__bindingPointIndex),h.set(ae,ue))}function Ue(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),a={},c={},ie=null,re={},l={},f=new WeakMap,m=[],x=null,p=!1,g=null,b=null,C=null,M=null,w=null,A=null,R=null,v=new Le(0,0,0),T=0,L=!1,E=null,P=null,F=null,k=null,U=null,Oe.set(0,0,i.canvas.width,i.canvas.height),De.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),u.reset()}return{buffers:{color:r,depth:o,stencil:u},enable:j,disable:Te,bindFramebuffer:Ce,drawBuffers:we,useProgram:st,setBlending:ke,setMaterial:He,setFlipSided:tt,setCullFace:ft,setLineWidth:gt,setPolygonOffset:yt,setScissorTest:at,activeTexture:ht,bindTexture:D,unbindTexture:Lt,compressedTexImage2D:Je,compressedTexImage3D:S,texImage2D:Y,texImage3D:K,pixelStorei:Me,getParameter:le,updateUBOMapping:Ae,uniformBlockBinding:Re,texStorage2D:ne,texStorage3D:oe,texSubImage2D:_,texSubImage3D:O,compressedTexSubImage2D:G,compressedTexSubImage3D:q,scissor:he,viewport:ce,reset:Ue}}function Um(i,e,t,n,s,r,o){let u=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,h=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),d=new Xe,a=new WeakMap,c=new Set,l,f=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(S,_){return m?new OffscreenCanvas(S,_):Qi("canvas")}function p(S,_,O){let G=1,q=Je(S);if((q.width>O||q.height>O)&&(G=O/Math.max(q.width,q.height)),G<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){let ne=Math.floor(G*q.width),oe=Math.floor(G*q.height);l===void 0&&(l=x(ne,oe));let Y=_?x(ne,oe):l;return Y.width=ne,Y.height=oe,Y.getContext("2d").drawImage(S,0,0,ne,oe),Ee("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+ne+"x"+oe+")."),Y}else return"data"in S&&Ee("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),S;return S}function g(S){return S.generateMipmaps}function b(S){i.generateMipmap(S)}function C(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(S,_,O,G,q,ne=!1){if(S!==null){if(i[S]!==void 0)return i[S];Ee("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let oe;G&&(oe=e.get("EXT_texture_norm16"),oe||Ee("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=_;if(_===i.RED&&(O===i.FLOAT&&(Y=i.R32F),O===i.HALF_FLOAT&&(Y=i.R16F),O===i.UNSIGNED_BYTE&&(Y=i.R8),O===i.UNSIGNED_SHORT&&oe&&(Y=oe.R16_EXT),O===i.SHORT&&oe&&(Y=oe.R16_SNORM_EXT)),_===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.R8UI),O===i.UNSIGNED_SHORT&&(Y=i.R16UI),O===i.UNSIGNED_INT&&(Y=i.R32UI),O===i.BYTE&&(Y=i.R8I),O===i.SHORT&&(Y=i.R16I),O===i.INT&&(Y=i.R32I)),_===i.RG&&(O===i.FLOAT&&(Y=i.RG32F),O===i.HALF_FLOAT&&(Y=i.RG16F),O===i.UNSIGNED_BYTE&&(Y=i.RG8),O===i.UNSIGNED_SHORT&&oe&&(Y=oe.RG16_EXT),O===i.SHORT&&oe&&(Y=oe.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RG8UI),O===i.UNSIGNED_SHORT&&(Y=i.RG16UI),O===i.UNSIGNED_INT&&(Y=i.RG32UI),O===i.BYTE&&(Y=i.RG8I),O===i.SHORT&&(Y=i.RG16I),O===i.INT&&(Y=i.RG32I)),_===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),O===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),O===i.UNSIGNED_INT&&(Y=i.RGB32UI),O===i.BYTE&&(Y=i.RGB8I),O===i.SHORT&&(Y=i.RGB16I),O===i.INT&&(Y=i.RGB32I)),_===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),O===i.UNSIGNED_INT&&(Y=i.RGBA32UI),O===i.BYTE&&(Y=i.RGBA8I),O===i.SHORT&&(Y=i.RGBA16I),O===i.INT&&(Y=i.RGBA32I)),_===i.RGB&&(O===i.UNSIGNED_SHORT&&oe&&(Y=oe.RGB16_EXT),O===i.SHORT&&oe&&(Y=oe.RGB16_SNORM_EXT),O===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(Y=i.R11F_G11F_B10F)),_===i.RGBA){let K=ne?Ki:Ge.getTransfer(q);O===i.FLOAT&&(Y=i.RGBA32F),O===i.HALF_FLOAT&&(Y=i.RGBA16F),O===i.UNSIGNED_BYTE&&(Y=K===Ze?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT&&oe&&(Y=oe.RGBA16_EXT),O===i.SHORT&&oe&&(Y=oe.RGBA16_SNORM_EXT),O===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function w(S,_){let O;return S?_===null||_===Kt||_===zi?O=i.DEPTH24_STENCIL8:_===Qt?O=i.DEPTH32F_STENCIL8:_===Bi&&(O=i.DEPTH24_STENCIL8,Ee("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Kt||_===zi?O=i.DEPTH_COMPONENT24:_===Qt?O=i.DEPTH_COMPONENT32F:_===Bi&&(O=i.DEPTH_COMPONENT16),O}function A(S,_){return g(S)===!0||S.isFramebufferTexture&&S.minFilter!==xt&&S.minFilter!==At?Math.log2(Math.max(_.width,_.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?_.mipmaps.length:1}function R(S){let _=S.target;_.removeEventListener("dispose",R),T(_),_.isVideoTexture&&a.delete(_),_.isHTMLTexture&&c.delete(_)}function v(S){let _=S.target;_.removeEventListener("dispose",v),E(_)}function T(S){let _=n.get(S);if(_.__webglInit===void 0)return;let O=S.source,G=f.get(O);if(G){let q=G[_.__cacheKey];q.usedTimes--,q.usedTimes===0&&L(S),Object.keys(G).length===0&&f.delete(O)}n.remove(S)}function L(S){let _=n.get(S);i.deleteTexture(_.__webglTexture);let O=S.source,G=f.get(O);delete G[_.__cacheKey],o.memory.textures--}function E(S){let _=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(_.__webglFramebuffer[G]))for(let q=0;q<_.__webglFramebuffer[G].length;q++)i.deleteFramebuffer(_.__webglFramebuffer[G][q]);else i.deleteFramebuffer(_.__webglFramebuffer[G]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[G])}else{if(Array.isArray(_.__webglFramebuffer))for(let G=0;G<_.__webglFramebuffer.length;G++)i.deleteFramebuffer(_.__webglFramebuffer[G]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let G=0;G<_.__webglColorRenderbuffer.length;G++)_.__webglColorRenderbuffer[G]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[G]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let O=S.textures;for(let G=0,q=O.length;G<q;G++){let ne=n.get(O[G]);ne.__webglTexture&&(i.deleteTexture(ne.__webglTexture),o.memory.textures--),n.remove(O[G])}n.remove(S)}let P=0;function F(){P=0}function k(){return P}function U(S){P=S}function X(){let S=P;return S>=s.maxTextures&&Ee("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),P+=1,S}function H(S){let _=[];return _.push(S.wrapS),_.push(S.wrapT),_.push(S.wrapR||0),_.push(S.magFilter),_.push(S.minFilter),_.push(S.anisotropy),_.push(S.internalFormat),_.push(S.format),_.push(S.type),_.push(S.generateMipmaps),_.push(S.premultiplyAlpha),_.push(S.flipY),_.push(S.unpackAlignment),_.push(S.colorSpace),_.join()}function J(S,_){let O=n.get(S);if(S.isVideoTexture&&D(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&O.__version!==S.version){let G=S.image;if(G===null)Ee("WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)Ee("WebGLRenderer: Texture marked for update but image is incomplete");else{Te(O,S,_);return}}else S.isExternalTexture&&(O.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+_)}function ee(S,_){let O=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&O.__version!==S.version){Te(O,S,_);return}else S.isExternalTexture&&(O.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+_)}function ie(S,_){let O=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&O.__version!==S.version){Te(O,S,_);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+_)}function re(S,_){let O=n.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&O.__version!==S.version){Ce(O,S,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+_)}let se={[mr]:i.REPEAT,[rn]:i.CLAMP_TO_EDGE,[gr]:i.MIRRORED_REPEAT},Ne={[xt]:i.NEAREST,[mc]:i.NEAREST_MIPMAP_NEAREST,[xs]:i.NEAREST_MIPMAP_LINEAR,[At]:i.LINEAR,[Wr]:i.LINEAR_MIPMAP_NEAREST,[Xn]:i.LINEAR_MIPMAP_LINEAR},Oe={[xc]:i.NEVER,[bc]:i.ALWAYS,[vc]:i.LESS,[Ca]:i.LEQUAL,[yc]:i.EQUAL,[Ra]:i.GEQUAL,[Mc]:i.GREATER,[Sc]:i.NOTEQUAL};function De(S,_){if(_.type===Qt&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===At||_.magFilter===Wr||_.magFilter===xs||_.magFilter===Xn||_.minFilter===At||_.minFilter===Wr||_.minFilter===xs||_.minFilter===Xn)&&Ee("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,se[_.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,se[_.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,se[_.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,Ne[_.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,Ne[_.minFilter]),_.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,Oe[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===xt||_.minFilter!==xs&&_.minFilter!==Xn||_.type===Qt&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(S,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Z(S,_){let O=!1;S.__webglInit===void 0&&(S.__webglInit=!0,_.addEventListener("dispose",R));let G=_.source,q=f.get(G);q===void 0&&(q={},f.set(G,q));let ne=H(_);if(ne!==S.__cacheKey){q[ne]===void 0&&(q[ne]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,O=!0),q[ne].usedTimes++;let oe=q[S.__cacheKey];oe!==void 0&&(q[S.__cacheKey].usedTimes--,oe.usedTimes===0&&L(_)),S.__cacheKey=ne,S.__webglTexture=q[ne].texture}return O}function te(S,_,O){return Math.floor(Math.floor(S/O)/_)}function j(S,_,O,G){let ne=S.updateRanges;if(ne.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,O,G,_.data);else{ne.sort((Me,he)=>Me.start-he.start);let oe=0;for(let Me=1;Me<ne.length;Me++){let he=ne[oe],ce=ne[Me],Ae=he.start+he.count,Re=te(ce.start,_.width,4),Ue=te(he.start,_.width,4);ce.start<=Ae+1&&Re===Ue&&te(ce.start+ce.count-1,_.width,4)===Re?he.count=Math.max(he.count,ce.start+ce.count-he.start):(++oe,ne[oe]=ce)}ne.length=oe+1;let Y=t.getParameter(i.UNPACK_ROW_LENGTH),K=t.getParameter(i.UNPACK_SKIP_PIXELS),le=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Me=0,he=ne.length;Me<he;Me++){let ce=ne[Me],Ae=Math.floor(ce.start/4),Re=Math.ceil(ce.count/4),Ue=Ae%_.width,I=Math.floor(Ae/_.width),ae=Re,$=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ue),t.pixelStorei(i.UNPACK_SKIP_ROWS,I),t.texSubImage2D(i.TEXTURE_2D,0,Ue,I,ae,$,O,G,_.data)}S.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,Y),t.pixelStorei(i.UNPACK_SKIP_PIXELS,K),t.pixelStorei(i.UNPACK_SKIP_ROWS,le)}}function Te(S,_,O){let G=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(G=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(G=i.TEXTURE_3D);let q=Z(S,_),ne=_.source;t.bindTexture(G,S.__webglTexture,i.TEXTURE0+O);let oe=n.get(ne);if(ne.version!==oe.__version||q===!0){if(t.activeTexture(i.TEXTURE0+O),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){let $=Ge.getPrimaries(Ge.workingColorSpace),ue=_.colorSpace===En?null:Ge.getPrimaries(_.colorSpace),me=_.colorSpace===En||$===ue?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,me)}t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let K=p(_.image,!1,s.maxTextureSize);K=Lt(_,K);let le=r.convert(_.format,_.colorSpace),Me=r.convert(_.type),he=M(_.internalFormat,le,Me,_.normalized,_.colorSpace,_.isVideoTexture);De(G,_);let ce,Ae=_.mipmaps,Re=_.isVideoTexture!==!0,Ue=oe.__version===void 0||q===!0,I=ne.dataReady,ae=A(_,K);if(_.isDepthTexture)he=w(_.format===qn,_.type),Ue&&(Re?t.texStorage2D(i.TEXTURE_2D,1,he,K.width,K.height):t.texImage2D(i.TEXTURE_2D,0,he,K.width,K.height,0,le,Me,null));else if(_.isDataTexture)if(Ae.length>0){Re&&Ue&&t.texStorage2D(i.TEXTURE_2D,ae,he,Ae[0].width,Ae[0].height);for(let $=0,ue=Ae.length;$<ue;$++)ce=Ae[$],Re?I&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,ce.width,ce.height,le,Me,ce.data):t.texImage2D(i.TEXTURE_2D,$,he,ce.width,ce.height,0,le,Me,ce.data);_.generateMipmaps=!1}else Re?(Ue&&t.texStorage2D(i.TEXTURE_2D,ae,he,K.width,K.height),I&&j(_,K,le,Me)):t.texImage2D(i.TEXTURE_2D,0,he,K.width,K.height,0,le,Me,K.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Re&&Ue&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,he,Ae[0].width,Ae[0].height,K.depth);for(let $=0,ue=Ae.length;$<ue;$++)if(ce=Ae[$],_.format!==Xt)if(le!==null)if(Re){if(I)if(_.layerUpdates.size>0){let me=Zo(ce.width,ce.height,_.format,_.type);for(let Q of _.layerUpdates){let ye=ce.data.subarray(Q*me/ce.data.BYTES_PER_ELEMENT,(Q+1)*me/ce.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,Q,ce.width,ce.height,1,le,ye)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,ce.width,ce.height,K.depth,le,ce.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,$,he,ce.width,ce.height,K.depth,0,ce.data,0,0);else Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Re?I&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,ce.width,ce.height,K.depth,le,Me,ce.data):t.texImage3D(i.TEXTURE_2D_ARRAY,$,he,ce.width,ce.height,K.depth,0,le,Me,ce.data)}else{Re&&Ue&&t.texStorage2D(i.TEXTURE_2D,ae,he,Ae[0].width,Ae[0].height);for(let $=0,ue=Ae.length;$<ue;$++)ce=Ae[$],_.format!==Xt?le!==null?Re?I&&t.compressedTexSubImage2D(i.TEXTURE_2D,$,0,0,ce.width,ce.height,le,ce.data):t.compressedTexImage2D(i.TEXTURE_2D,$,he,ce.width,ce.height,0,ce.data):Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Re?I&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,ce.width,ce.height,le,Me,ce.data):t.texImage2D(i.TEXTURE_2D,$,he,ce.width,ce.height,0,le,Me,ce.data)}else if(_.isDataArrayTexture)if(Re){if(Ue&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,he,K.width,K.height,K.depth),I)if(_.layerUpdates.size>0){let $=Zo(K.width,K.height,_.format,_.type);for(let ue of _.layerUpdates){let me=K.data.subarray(ue*$/K.data.BYTES_PER_ELEMENT,(ue+1)*$/K.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ue,K.width,K.height,1,le,Me,me)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,le,Me,K.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,he,K.width,K.height,K.depth,0,le,Me,K.data);else if(_.isData3DTexture)Re?(Ue&&t.texStorage3D(i.TEXTURE_3D,ae,he,K.width,K.height,K.depth),I&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,le,Me,K.data)):t.texImage3D(i.TEXTURE_3D,0,he,K.width,K.height,K.depth,0,le,Me,K.data);else if(_.isFramebufferTexture){if(Ue)if(Re)t.texStorage2D(i.TEXTURE_2D,ae,he,K.width,K.height);else{let $=K.width,ue=K.height;for(let me=0;me<ae;me++)t.texImage2D(i.TEXTURE_2D,me,he,$,ue,0,le,Me,null),$>>=1,ue>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){let $=i.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),K.parentNode!==$){$.appendChild(K),c.add(_),$.onpaint=ue=>{let me=ue.changedElements;for(let Q of c)me.includes(Q.image)&&(Q.needsUpdate=!0)},$.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,K);else{let me=i.RGBA,Q=i.RGBA,ye=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,me,Q,ye,K)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ae.length>0){if(Re&&Ue){let $=Je(Ae[0]);t.texStorage2D(i.TEXTURE_2D,ae,he,$.width,$.height)}for(let $=0,ue=Ae.length;$<ue;$++)ce=Ae[$],Re?I&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,le,Me,ce):t.texImage2D(i.TEXTURE_2D,$,he,le,Me,ce);_.generateMipmaps=!1}else if(Re){if(Ue){let $=Je(K);t.texStorage2D(i.TEXTURE_2D,ae,he,$.width,$.height)}I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,le,Me,K)}else t.texImage2D(i.TEXTURE_2D,0,he,le,Me,K);g(_)&&b(G),oe.__version=ne.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function Ce(S,_,O){if(_.image.length!==6)return;let G=Z(S,_),q=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+O);let ne=n.get(q);if(q.version!==ne.__version||G===!0){t.activeTexture(i.TEXTURE0+O);let oe=Ge.getPrimaries(Ge.workingColorSpace),Y=_.colorSpace===En?null:Ge.getPrimaries(_.colorSpace),K=_.colorSpace===En||oe===Y?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);let le=_.isCompressedTexture||_.image[0].isCompressedTexture,Me=_.image[0]&&_.image[0].isDataTexture,he=[];for(let Q=0;Q<6;Q++)!le&&!Me?he[Q]=p(_.image[Q],!0,s.maxCubemapSize):he[Q]=Me?_.image[Q].image:_.image[Q],he[Q]=Lt(_,he[Q]);let ce=he[0],Ae=r.convert(_.format,_.colorSpace),Re=r.convert(_.type),Ue=M(_.internalFormat,Ae,Re,_.normalized,_.colorSpace),I=_.isVideoTexture!==!0,ae=ne.__version===void 0||G===!0,$=q.dataReady,ue=A(_,ce);De(i.TEXTURE_CUBE_MAP,_);let me;if(le){I&&ae&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ue,Ue,ce.width,ce.height);for(let Q=0;Q<6;Q++){me=he[Q].mipmaps;for(let ye=0;ye<me.length;ye++){let xe=me[ye];_.format!==Xt?Ae!==null?I?$&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,0,0,xe.width,xe.height,Ae,xe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,Ue,xe.width,xe.height,0,xe.data):Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,0,0,xe.width,xe.height,Ae,Re,xe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,Ue,xe.width,xe.height,0,Ae,Re,xe.data)}}}else{if(me=_.mipmaps,I&&ae){me.length>0&&ue++;let Q=Je(he[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ue,Ue,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(Me){I?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,he[Q].width,he[Q].height,Ae,Re,he[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ue,he[Q].width,he[Q].height,0,Ae,Re,he[Q].data);for(let ye=0;ye<me.length;ye++){let ot=me[ye].image[Q].image;I?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,0,0,ot.width,ot.height,Ae,Re,ot.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,Ue,ot.width,ot.height,0,Ae,Re,ot.data)}}else{I?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Ae,Re,he[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ue,Ae,Re,he[Q]);for(let ye=0;ye<me.length;ye++){let xe=me[ye];I?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,0,0,Ae,Re,xe.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,Ue,Ae,Re,xe.image[Q])}}}g(_)&&b(i.TEXTURE_CUBE_MAP),ne.__version=q.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function we(S,_,O,G,q,ne){let oe=r.convert(O.format,O.colorSpace),Y=r.convert(O.type),K=M(O.internalFormat,oe,Y,O.normalized,O.colorSpace),le=n.get(_),Me=n.get(O);if(Me.__renderTarget=_,!le.__hasExternalTextures){let he=Math.max(1,_.width>>ne),ce=Math.max(1,_.height>>ne);q===i.TEXTURE_3D||q===i.TEXTURE_2D_ARRAY?t.texImage3D(q,ne,K,he,ce,_.depth,0,oe,Y,null):t.texImage2D(q,ne,K,he,ce,0,oe,Y,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),ht(_)?u.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,G,q,Me.__webglTexture,0,at(_)):(q===i.TEXTURE_2D||q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,G,q,Me.__webglTexture,ne),t.bindFramebuffer(i.FRAMEBUFFER,null)}function st(S,_,O){if(i.bindRenderbuffer(i.RENDERBUFFER,S),_.depthBuffer){let G=_.depthTexture,q=G&&G.isDepthTexture?G.type:null,ne=w(_.stencilBuffer,q),oe=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ht(_)?u.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,at(_),ne,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,at(_),ne,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ne,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,S)}else{let G=_.textures;for(let q=0;q<G.length;q++){let ne=G[q],oe=r.convert(ne.format,ne.colorSpace),Y=r.convert(ne.type),K=M(ne.internalFormat,oe,Y,ne.normalized,ne.colorSpace);ht(_)?u.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,at(_),K,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,at(_),K,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,K,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Be(S,_,O){let G=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let q=n.get(_.depthTexture);if(q.__renderTarget=_,(!q.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),G){if(q.__webglInit===void 0&&(q.__webglInit=!0,_.depthTexture.addEventListener("dispose",R)),q.__webglTexture===void 0){q.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),De(i.TEXTURE_CUBE_MAP,_.depthTexture);let le=r.convert(_.depthTexture.format),Me=r.convert(_.depthTexture.type),he;_.depthTexture.format===an?he=i.DEPTH_COMPONENT24:_.depthTexture.format===qn&&(he=i.DEPTH24_STENCIL8);for(let ce=0;ce<6;ce++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,he,_.width,_.height,0,le,Me,null)}}else J(_.depthTexture,0);let ne=q.__webglTexture,oe=at(_),Y=G?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,K=_.depthTexture.format===qn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===an)ht(_)?u.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Y,ne,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,K,Y,ne,0);else if(_.depthTexture.format===qn)ht(_)?u.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Y,ne,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,K,Y,ne,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function qe(S){let _=n.get(S),O=S.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==S.depthTexture){let G=S.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),G){let q=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,G.removeEventListener("dispose",q)};G.addEventListener("dispose",q),_.__depthDisposeCallback=q}_.__boundDepthTexture=G}if(S.depthTexture&&!_.__autoAllocateDepthBuffer)if(O)for(let G=0;G<6;G++)Be(_.__webglFramebuffer[G],S,G);else{let G=S.texture.mipmaps;G&&G.length>0?Be(_.__webglFramebuffer[0],S,0):Be(_.__webglFramebuffer,S,0)}else if(O){_.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[G]),_.__webglDepthbuffer[G]===void 0)_.__webglDepthbuffer[G]=i.createRenderbuffer(),st(_.__webglDepthbuffer[G],S,!1);else{let q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=_.__webglDepthbuffer[G];i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,ne)}}else{let G=S.texture.mipmaps;if(G&&G.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),st(_.__webglDepthbuffer,S,!1);else{let q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,ne)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ke(S,_,O){let G=n.get(S);_!==void 0&&we(G.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&qe(S)}function He(S){let _=S.texture,O=n.get(S),G=n.get(_);S.addEventListener("dispose",v);let q=S.textures,ne=S.isWebGLCubeRenderTarget===!0,oe=q.length>1;if(oe||(G.__webglTexture===void 0&&(G.__webglTexture=i.createTexture()),G.__version=_.version,o.memory.textures++),ne){O.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer[Y]=[];for(let K=0;K<_.mipmaps.length;K++)O.__webglFramebuffer[Y][K]=i.createFramebuffer()}else O.__webglFramebuffer[Y]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer=[];for(let Y=0;Y<_.mipmaps.length;Y++)O.__webglFramebuffer[Y]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(oe)for(let Y=0,K=q.length;Y<K;Y++){let le=n.get(q[Y]);le.__webglTexture===void 0&&(le.__webglTexture=i.createTexture(),o.memory.textures++)}if(S.samples>0&&ht(S)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let Y=0;Y<q.length;Y++){let K=q[Y];O.__webglColorRenderbuffer[Y]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[Y]);let le=r.convert(K.format,K.colorSpace),Me=r.convert(K.type),he=M(K.internalFormat,le,Me,K.normalized,K.colorSpace,S.isXRRenderTarget===!0),ce=at(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,ce,he,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Y,i.RENDERBUFFER,O.__webglColorRenderbuffer[Y])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),st(O.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ne){t.bindTexture(i.TEXTURE_CUBE_MAP,G.__webglTexture),De(i.TEXTURE_CUBE_MAP,_);for(let Y=0;Y<6;Y++)if(_.mipmaps&&_.mipmaps.length>0)for(let K=0;K<_.mipmaps.length;K++)we(O.__webglFramebuffer[Y][K],S,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,K);else we(O.__webglFramebuffer[Y],S,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);g(_)&&b(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let Y=0,K=q.length;Y<K;Y++){let le=q[Y],Me=n.get(le),he=i.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(he=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(he,Me.__webglTexture),De(he,le),we(O.__webglFramebuffer,S,le,i.COLOR_ATTACHMENT0+Y,he,0),g(le)&&b(he)}t.unbindTexture()}else{let Y=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(Y=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Y,G.__webglTexture),De(Y,_),_.mipmaps&&_.mipmaps.length>0)for(let K=0;K<_.mipmaps.length;K++)we(O.__webglFramebuffer[K],S,_,i.COLOR_ATTACHMENT0,Y,K);else we(O.__webglFramebuffer,S,_,i.COLOR_ATTACHMENT0,Y,0);g(_)&&b(Y),t.unbindTexture()}S.depthBuffer&&qe(S)}function tt(S){let _=S.textures;for(let O=0,G=_.length;O<G;O++){let q=_[O];if(g(q)){let ne=C(S),oe=n.get(q).__webglTexture;t.bindTexture(ne,oe),b(ne),t.unbindTexture()}}}let ft=[],gt=[];function yt(S){if(S.samples>0){if(ht(S)===!1){let _=S.textures,O=S.width,G=S.height,q=i.COLOR_BUFFER_BIT,ne=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(S),Y=_.length>1;if(Y)for(let le=0;le<_.length;le++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);let K=S.texture.mipmaps;K&&K.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let le=0;le<_.length;le++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(q|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(q|=i.STENCIL_BUFFER_BIT)),Y){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[le]);let Me=n.get(_[le]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Me,0)}i.blitFramebuffer(0,0,O,G,0,0,O,G,q,i.NEAREST),h===!0&&(ft.length=0,gt.length=0,ft.push(i.COLOR_ATTACHMENT0+le),S.depthBuffer&&S.resolveDepthBuffer===!1&&(ft.push(ne),gt.push(ne),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,gt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ft))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Y)for(let le=0;le<_.length;le++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.RENDERBUFFER,oe.__webglColorRenderbuffer[le]);let Me=n.get(_[le]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.TEXTURE_2D,Me,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&h){let _=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function at(S){return Math.min(s.maxSamples,S.samples)}function ht(S){let _=n.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function D(S){let _=o.render.frame;a.get(S)!==_&&(a.set(S,_),S.update())}function Lt(S,_){let O=S.colorSpace,G=S.format,q=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||O!==$i&&O!==En&&(Ge.getTransfer(O)===Ze?(G!==Xt||q!==Ut)&&Ee("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ie("WebGLTextures: Unsupported texture color space:",O)),_}function Je(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(d.width=S.naturalWidth||S.width,d.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(d.width=S.displayWidth,d.height=S.displayHeight):(d.width=S.width,d.height=S.height),d}this.allocateTextureUnit=X,this.resetTextureUnits=F,this.getTextureUnits=k,this.setTextureUnits=U,this.setTexture2D=J,this.setTexture2DArray=ee,this.setTexture3D=ie,this.setTextureCube=re,this.rebindTextures=ke,this.setupRenderTarget=He,this.updateRenderTargetMipmap=tt,this.updateMultisampleRenderTarget=yt,this.setupDepthRenderbuffer=qe,this.setupFrameBufferTexture=we,this.useMultisampledRTT=ht,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Fm(i,e){function t(n,s=En){let r,o=Ge.getTransfer(s);if(n===Ut)return i.UNSIGNED_BYTE;if(n===qr)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Yr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Bo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===zo)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Fo)return i.BYTE;if(n===Oo)return i.SHORT;if(n===Bi)return i.UNSIGNED_SHORT;if(n===Xr)return i.INT;if(n===Kt)return i.UNSIGNED_INT;if(n===Qt)return i.FLOAT;if(n===dn)return i.HALF_FLOAT;if(n===Vo)return i.ALPHA;if(n===ko)return i.RGB;if(n===Xt)return i.RGBA;if(n===an)return i.DEPTH_COMPONENT;if(n===qn)return i.DEPTH_STENCIL;if(n===Go)return i.RED;if(n===Zr)return i.RED_INTEGER;if(n===Yn)return i.RG;if(n===Jr)return i.RG_INTEGER;if(n===$r)return i.RGBA_INTEGER;if(n===vs||n===ys||n===Ms||n===Ss)if(o===Ze)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===vs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ys)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ms)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ss)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===vs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ys)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ms)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ss)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Kr||n===Qr||n===jr||n===ea)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Kr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Qr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===jr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ea)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ta||n===na||n===ia||n===sa||n===ra||n===bs||n===aa)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ta||n===na)return o===Ze?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ia)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===sa)return r.COMPRESSED_R11_EAC;if(n===ra)return r.COMPRESSED_SIGNED_R11_EAC;if(n===bs)return r.COMPRESSED_RG11_EAC;if(n===aa)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===oa||n===la||n===ca||n===ua||n===ha||n===da||n===fa||n===pa||n===ma||n===ga||n===_a||n===xa||n===va||n===ya)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===oa)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===la)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ca)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ua)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ha)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===da)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===fa)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===pa)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ma)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ga)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===_a)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===xa)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===va)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ya)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ma||n===Sa||n===ba)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ma)return o===Ze?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Sa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ba)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Aa||n===Ta||n===As||n===Ea)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Aa)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ta)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===As)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ea)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===zi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}var Om=`
void main() {
...
}`,ll=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new as(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new kt({vertexShader:Om,fragmentShader:Bm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new It(new ai(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},cl=class extends on{constructor(e,t){super();let n=this,s=null,r=1,o=null,u="local-floor",h=1,d=null,a=null,c=null,l=null,f=null,m=null,x=typeof XRWebGLBinding<"u",p=new ll,g={},b=t.getContextAttributes(),C=null,M=null,w=[],A=[],R=new Xe,v=null,T=new Mt;T.viewport=new rt;let L=new Mt;L.viewport=new rt;let E=[T,L],P=new kr,F=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let te=w[Z];return te===void 0&&(te=new Ci,w[Z]=te),te.getTargetRaySpace()},this.getControllerGrip=function(Z){let te=w[Z];return te===void 0&&(te=new Ci,w[Z]=te),te.getGripSpace()},this.getHand=function(Z){let te=w[Z];return te===void 0&&(te=new Ci,w[Z]=te),te.getHandSpace()};function U(Z){let te=A.indexOf(Z.inputSource);if(te===-1)return;let j=w[te];j!==void 0&&(j.update(Z.inputSource,Z.frame,d||o),j.dispatchEvent({type:Z.type,data:Z.inputSource}))}function X(){s.removeEventListener("select",U),s.removeEventListener("selectstart",U),s.removeEventListener("selectend",U),s.removeEventListener("squeeze",U),s.removeEventListener("squeezestart",U),s.removeEventListener("squeezeend",U),s.removeEventListener("end",X),s.removeEventListener("inputsourceschange",H);for(let Z=0;Z<w.length;Z++){let te=A[Z];te!==null&&(A[Z]=null,w[Z].disconnect(te))}F=null,k=null,p.reset();for(let Z in g)delete g[Z];e.setRenderTarget(C),f=null,l=null,c=null,s=null,M=null,De.stop(),n.isPresenting=!1,e.setPixelRatio(v),e.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){r=Z,n.isPresenting===!0&&Ee("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){u=Z,n.isPresenting===!0&&Ee("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return d||o},this.setReferenceSpace=function(Z){d=Z},this.getBaseLayer=function(){return l!==null?l:f},this.getBinding=function(){return c===null&&x&&(c=new XRWebGLBinding(s,t)),c},this.getFrame=function(){return m},this.getSession=function(){return s},this.setSession=async function(Z){if(s=Z,s!==null){if(C=e.getRenderTarget(),s.addEventListener("select",U),s.addEventListener("selectstart",U),s.addEventListener("selectend",U),s.addEventListener("squeeze",U),s.addEventListener("squeezestart",U),s.addEventListener("squeezeend",U),s.addEventListener("end",X),s.addEventListener("inputsourceschange",H),b.xrCompatible!==!0&&await t.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(R),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let j=null,Te=null,Ce=null;b.depth&&(Ce=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,j=b.stencil?qn:an,Te=b.stencil?zi:Kt);let we={colorFormat:t.RGBA8,depthFormat:Ce,scaleFactor:r};c=this.getBinding(),l=c.createProjectionLayer(we),s.updateRenderState({layers:[l]}),e.setPixelRatio(1),e.setSize(l.textureWidth,l.textureHeight,!1),M=new Vt(l.textureWidth,l.textureHeight,{format:Xt,type:Ut,depthTexture:new Tn(l.textureWidth,l.textureHeight,Te,void 0,void 0,void 0,void 0,void 0,void 0,j),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:l.ignoreDepthValues===!1,resolveStencilBuffer:l.ignoreDepthValues===!1})}else{let j={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,t,j),s.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new Vt(f.framebufferWidth,f.framebufferHeight,{format:Xt,type:Ut,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(h),d=null,o=await s.requestReferenceSpace(u),De.setContext(s),De.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function H(Z){for(let te=0;te<Z.removed.length;te++){let j=Z.removed[te],Te=A.indexOf(j);Te>=0&&(A[Te]=null,w[Te].disconnect(j))}for(let te=0;te<Z.added.length;te++){let j=Z.added[te],Te=A.indexOf(j);if(Te===-1){for(let we=0;we<w.length;we++)if(we>=A.length){A.push(j),Te=we;break}else if(A[we]===null){A[we]=j,Te=we;break}if(Te===-1)break}let Ce=w[Te];Ce&&Ce.connect(j)}}let J=new B,ee=new B;function ie(Z,te,j){J.setFromMatrixPosition(te.matrixWorld),ee.setFromMatrixPosition(j.matrixWorld);let Te=J.distanceTo(ee),Ce=te.projectionMatrix.elements,we=j.projectionMatrix.elements,st=Ce[14]/(Ce[10]-1),Be=Ce[14]/(Ce[10]+1),qe=(Ce[9]+1)/Ce[5],ke=(Ce[9]-1)/Ce[5],He=(Ce[8]-1)/Ce[0],tt=(we[8]+1)/we[0],ft=st*He,gt=st*tt,yt=Te/(-He+tt),at=yt*-He;if(te.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(at),Z.translateZ(yt),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Ce[10]===-1)Z.projectionMatrix.copy(te.projectionMatrix),Z.projectionMatrixInverse.copy(te.projectionMatrixInverse);else{let ht=st+yt,D=Be+yt,Lt=ft-at,Je=gt+(Te-at),S=qe*Be/D*ht,_=ke*Be/D*ht;Z.projectionMatrix.makePerspective(Lt,Je,S,_,ht,D),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function re(Z,te){te===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(te.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(s===null)return;let te=Z.near,j=Z.far;p.texture!==null&&(p.depthNear>0&&(te=p.depthNear),p.depthFar>0&&(j=p.depthFar)),P.near=L.near=T.near=te,P.far=L.far=T.far=j,(F!==P.near||k!==P.far)&&(s.updateRenderState({depthNear:P.near,depthFar:P.far}),F=P.near,k=P.far),P.layers.mask=Z.layers.mask|6,T.layers.mask=P.layers.mask&-5,L.layers.mask=P.layers.mask&-3;let Te=Z.parent,Ce=P.cameras;re(P,Te);for(let we=0;we<Ce.length;we++)re(Ce[we],Te);Ce.length===2?ie(P,T,L):P.projectionMatrix.copy(T.projectionMatrix),se(Z,P,Te)};function se(Z,te,j){j===null?Z.matrix.copy(te.matrixWorld):(Z.matrix.copy(j.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(te.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(te.projectionMatrix),Z.projectionMatrixInverse.copy(te.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=xr*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return P},this.getFoveation=function(){if(!(l===null&&f===null))return h},this.setFoveation=function(Z){h=Z,l!==null&&(l.fixedFoveation=Z),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Z)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(P)},this.getCameraTexture=function(Z){return g[Z]};let Ne=null;function Oe(Z,te){if(a=te.getViewerPose(d||o),m=te,a!==null){let j=a.views;f!==null&&(e.setRenderTargetFramebuffer(M,f.framebuffer),e.setRenderTarget(M));let Te=!1;j.length!==P.cameras.length&&(P.cameras.length=0,Te=!0);for(let Be=0;Be<j.length;Be++){let qe=j[Be],ke=null;if(f!==null)ke=f.getViewport(qe);else{let tt=c.getViewSubImage(l,qe);ke=tt.viewport,Be===0&&(e.setRenderTargetTextures(M,tt.colorTexture,tt.depthStencilTexture),e.setRenderTarget(M))}let He=E[Be];He===void 0&&(He=new Mt,He.layers.enable(Be),He.viewport=new rt,E[Be]=He),He.matrix.fromArray(qe.transform.matrix),He.matrix.decompose(He.position,He.quaternion,He.scale),He.projectionMatrix.fromArray(qe.projectionMatrix),He.projectionMatrixInverse.copy(He.projectionMatrix).invert(),He.viewport.set(ke.x,ke.y,ke.width,ke.height),Be===0&&(P.matrix.copy(He.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale)),Te===!0&&P.cameras.push(He)}let Ce=s.enabledFeatures;if(Ce&&Ce.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&x){c=n.getBinding();let Be=c.getDepthInformation(j[0]);Be&&Be.isValid&&Be.texture&&p.init(Be,s.renderState)}if(Ce&&Ce.includes("camera-access")&&x){e.state.unbindTexture(),c=n.getBinding();for(let Be=0;Be<j.length;Be++){let qe=j[Be].camera;if(qe){let ke=g[qe];ke||(ke=new as,g[qe]=ke);let He=c.getCameraImage(qe);ke.sourceTexture=He}}}}for(let j=0;j<w.length;j++){let Te=A[j],Ce=w[j];Te!==null&&Ce!==void 0&&Ce.update(Te,te,d||o)}Ne&&Ne(Z,te),te.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:te}),m=null}let De=new jc;De.setAnimationLoop(Oe),this.setAnimationLoop=function(Z){Ne=Z},this.dispose=function(){}}},zm=new it,ru=new Pe;ru.set(-1,0,0,0,1,0,0,0,1);function Vm(i,e){function t(p,g){p.matrixAutoUpdate===!0&&p.updateMatrix(),g.value.copy(p.matrix)}function n(p,g){g.color.getRGB(p.fogColor.value,Xo(i)),g.isFog?(p.fogNear.value=g.near,p.fogFar.value=g.far):g.isFogExp2&&(p.fogDensity.value=g.density)}function s(p,g,b,C,M){g.isNodeMaterial?g.uniformsNeedUpdate=!1:g.isMeshBasicMaterial?r(p,g):g.isMeshLambertMaterial?(r(p,g),g.envMap&&(p.envMapIntensity.value=g.envMapIntensity)):g.isMeshToonMaterial?(r(p,g),c(p,g)):g.isMeshPhongMaterial?(r(p,g),a(p,g),g.envMap&&(p.envMapIntensity.value=g.envMapIntensity)):g.isMeshStandardMaterial?(r(p,g),l(p,g),g.isMeshPhysicalMaterial&&f(p,g,M)):g.isMeshMatcapMaterial?(r(p,g),m(p,g)):g.isMeshDepthMaterial?r(p,g):g.isMeshDistanceMaterial?(r(p,g),x(p,g)):g.isMeshNormalMaterial?r(p,g):g.isLineBasicMaterial?(o(p,g),g.isLineDashedMaterial&&u(p,g)):g.isPointsMaterial?h(p,g,b,C):g.isSpriteMaterial?d(p,g):g.isShadowMaterial?(p.color.value.copy(g.color),p.opacity.value=g.opacity):g.isShaderMaterial&&(g.uniformsNeedUpdate=!1)}function r(p,g){p.opacity.value=g.opacity,g.color&&p.diffuse.value.copy(g.color),g.emissive&&p.emissive.value.copy(g.emissive).multiplyScalar(g.emissiveIntensity),g.map&&(p.map.value=g.map,t(g.map,p.mapTransform)),g.alphaMap&&(p.alphaMap.value=g.alphaMap,t(g.alphaMap,p.alphaMapTransform)),g.bumpMap&&(p.bumpMap.value=g.bumpMap,t(g.bumpMap,p.bumpMapTransform),p.bumpScale.value=g.bumpScale,g.side===Pt&&(p.bumpScale.value*=-1)),g.normalMap&&(p.normalMap.value=g.normalMap,t(g.normalMap,p.normalMapTransform),p.normalScale.value.copy(g.normalScale),g.side===Pt&&p.normalScale.value.negate()),g.displacementMap&&(p.displacementMap.value=g.displacementMap,t(g.displacementMap,p.displacementMapTransform),p.displacementScale.value=g.displacementScale,p.displacementBias.value=g.displacementBias),g.emissiveMap&&(p.emissiveMap.value=g.emissiveMap,t(g.emissiveMap,p.emissiveMapTransform)),g.specularMap&&(p.specularMap.value=g.specularMap,t(g.specularMap,p.specularMapTransform)),g.alphaTest>0&&(p.alphaTest.value=g.alphaTest);let b=e.get(g),C=b.envMap,M=b.envMapRotation;C&&(p.envMap.value=C,p.envMapRotation.value.setFromMatrix4(zm.makeRotationFromEuler(M)).transpose(),C.isCubeTexture&&C.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(ru),p.reflectivity.value=g.reflectivity,p.ior.value=g.ior,p.refractionRatio.value=g.refractionRatio),g.lightMap&&(p.lightMap.value=g.lightMap,p.lightMapIntensity.value=g.lightMapIntensity,t(g.lightMap,p.lightMapTransform)),g.aoMap&&(p.aoMap.value=g.aoMap,p.aoMapIntensity.value=g.aoMapIntensity,t(g.aoMap,p.aoMapTransform))}function o(p,g){p.diffuse.value.copy(g.color),p.opacity.value=g.opacity,g.map&&(p.map.value=g.map,t(g.map,p.mapTransform))}function u(p,g){p.dashSize.value=g.dashSize,p.totalSize.value=g.dashSize+g.gapSize,p.scale.value=g.scale}function h(p,g,b,C){p.diffuse.value.copy(g.color),p.opacity.value=g.opacity,p.size.value=g.size*b,p.scale.value=C*.5,g.map&&(p.map.value=g.map,t(g.map,p.uvTransform)),g.alphaMap&&(p.alphaMap.value=g.alphaMap,t(g.alphaMap,p.alphaMapTransform)),g.alphaTest>0&&(p.alphaTest.value=g.alphaTest)}function d(p,g){p.diffuse.value.copy(g.color),p.opacity.value=g.opacity,p.rotation.value=g.rotation,g.map&&(p.map.value=g.map,t(g.map,p.mapTransform)),g.alphaMap&&(p.alphaMap.value=g.alphaMap,t(g.alphaMap,p.alphaMapTransform)),g.alphaTest>0&&(p.alphaTest.value=g.alphaTest)}function a(p,g){p.specular.value.copy(g.specular),p.shininess.value=Math.max(g.shininess,1e-4)}function c(p,g){g.gradientMap&&(p.gradientMap.value=g.gradientMap)}function l(p,g){p.metalness.value=g.metalness,g.metalnessMap&&(p.metalnessMap.value=g.metalnessMap,t(g.metalnessMap,p.metalnessMapTransform)),p.roughness.value=g.roughness,g.roughnessMap&&(p.roughnessMap.value=g.roughnessMap,t(g.roughnessMap,p.roughnessMapTransform)),g.envMap&&(p.envMapIntensity.value=g.envMapIntensity)}function f(p,g,b){p.ior.value=g.ior,g.sheen>0&&(p.sheenColor.value.copy(g.sheenColor).multiplyScalar(g.sheen),p.sheenRoughness.value=g.sheenRoughness,g.sheenColorMap&&(p.sheenColorMap.value=g.sheenColorMap,t(g.sheenColorMap,p.sheenColorMapTransform)),g.sheenRoughnessMap&&(p.sheenRoughnessMap.value=g.sheenRoughnessMap,t(g.sheenRoughnessMap,p.sheenRoughnessMapTransform))),g.clearcoat>0&&(p.clearcoat.value=g.clearcoat,p.clearcoatRoughness.value=g.clearcoatRoughness,g.clearcoatMap&&(p.clearcoatMap.value=g.clearcoatMap,t(g.clearcoatMap,p.clearcoatMapTransform)),g.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=g.clearcoatRoughnessMap,t(g.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),g.clearcoatNormalMap&&(p.clearcoatNormalMap.value=g.clearcoatNormalMap,t(g.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(g.clearcoatNormalScale),g.side===Pt&&p.clearcoatNormalScale.value.negate())),g.dispersion>0&&(p.dispersion.value=g.dispersion),g.iridescence>0&&(p.iridescence.value=g.iridescence,p.iridescenceIOR.value=g.iridescenceIOR,p.iridescenceThicknessMinimum.value=g.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=g.iridescenceThicknessRange[1],g.iridescenceMap&&(p.iridescenceMap.value=g.iridescenceMap,t(g.iridescenceMap,p.iridescenceMapTransform)),g.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=g.iridescenceThicknessMap,t(g.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),g.transmission>0&&(p.transmission.value=g.transmission,p.transmissionSamplerMap.value=b.texture,p.transmissionSamplerSize.value.set(b.width,b.height),g.transmissionMap&&(p.transmissionMap.value=g.transmissionMap,t(g.transmissionMap,p.transmissionMapTransform)),p.thickness.value=g.thickness,g.thicknessMap&&(p.thicknessMap.value=g.thicknessMap,t(g.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=g.attenuationDistance,p.attenuationColor.value.copy(g.attenuationColor)),g.anisotropy>0&&(p.anisotropyVector.value.set(g.anisotropy*Math.cos(g.anisotropyRotation),g.anisotropy*Math.sin(g.anisotropyRotation)),g.anisotropyMap&&(p.anisotropyMap.value=g.anisotropyMap,t(g.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=g.specularIntensity,p.specularColor.value.copy(g.specularColor),g.specularColorMap&&(p.specularColorMap.value=g.specularColorMap,t(g.specularColorMap,p.specularColorMapTransform)),g.specularIntensityMap&&(p.specularIntensityMap.value=g.specularIntensityMap,t(g.specularIntensityMap,p.specularIntensityMapTransform))}function m(p,g){g.matcap&&(p.matcap.value=g.matcap)}function x(p,g){let b=e.get(g).light;p.referencePosition.value.setFromMatrixPosition(b.matrixWorld),p.nearDistance.value=b.shadow.camera.near,p.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function km(i,e,t,n){let s={},r={},o=[],u=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function h(M,w){let A=w.program;n.uniformBlockBinding(M,A)}function d(M,w){let A=s[M.id];A===void 0&&(p(M),A=a(M),s[M.id]=A,M.addEventListener("dispose",b));let R=w.program;n.updateUBOMapping(M,R);let v=e.render.frame;r[M.id]!==v&&(l(M),r[M.id]=v)}function a(M){let w=c();M.__bindingPointIndex=w;let A=i.createBuffer(),R=M.__size,v=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,A),i.bufferData(i.UNIFORM_BUFFER,R,v),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,w,A),A}function c(){for(let M=0;M<u;M++)if(o.indexOf(M)===-1)return o.push(M),M;return Ie("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function l(M){let w=s[M.id],A=M.uniforms,R=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,w);for(let v=0,T=A.length;v<T;v++){let L=A[v];if(Array.isArray(L))for(let E=0,P=L.length;E<P;E++)f(L[E],v,E,R);else f(L,v,0,R)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(M,w,A,R){if(x(M,w,A,R)===!0){let v=M.__offset,T=M.value;if(Array.isArray(T)){let L=0;for(let E=0;E<T.length;E++){let P=T[E],F=g(P);m(P,M.__data,L),typeof P!="number"&&typeof P!="boolean"&&!P.isMatrix3&&!ArrayBuffer.isView(P)&&(L+=F.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(T,M.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,v,M.__data)}}function m(M,w,A){typeof M=="number"||typeof M=="boolean"?w[0]=M:M.isMatrix3?(w[0]=M.elements[0],w[1]=M.elements[1],w[2]=M.elements[2],w[3]=0,w[4]=M.elements[3],w[5]=M.elements[4],w[6]=M.elements[5],w[7]=0,w[8]=M.elements[6],w[9]=M.elements[7],w[10]=M.elements[8],w[11]=0):ArrayBuffer.isView(M)?w.set(new M.constructor(M.buffer,M.byteOffset,w.length)):M.toArray(w,A)}function x(M,w,A,R){let v=M.value,T=w+"_"+A;if(R[T]===void 0)return typeof v=="number"||typeof v=="boolean"?R[T]=v:ArrayBuffer.isView(v)?R[T]=v.slice():R[T]=v.clone(),!0;{let L=R[T];if(typeof v=="number"||typeof v=="boolean"){if(L!==v)return R[T]=v,!0}else{if(ArrayBuffer.isView(v))return!0;if(L.equals(v)===!1)return L.copy(v),!0}}return!1}function p(M){let w=M.uniforms,A=0,R=16;for(let T=0,L=w.length;T<L;T++){let E=Array.isArray(w[T])?w[T]:[w[T]];for(let P=0,F=E.length;P<F;P++){let k=E[P],U=Array.isArray(k.value)?k.value:[k.value];for(let X=0,H=U.length;X<H;X++){let J=U[X],ee=g(J),ie=A%R,re=ie%ee.boundary,se=ie+re;A+=re,se!==0&&R-se<ee.storage&&(A+=R-se),k.__data=new Float32Array(ee.storage/Float32Array.BYTES_PER_ELEMENT),k.__offset=A,A+=ee.storage}}}let v=A%R;return v>0&&(A+=R-v),M.__size=A,M.__cache={},this}function g(M){let w={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(w.boundary=4,w.storage=4):M.isVector2?(w.boundary=8,w.storage=8):M.isVector3||M.isColor?(w.boundary=16,w.storage=12):M.isVector4?(w.boundary=16,w.storage=16):M.isMatrix3?(w.boundary=48,w.storage=48):M.isMatrix4?(w.boundary=64,w.storage=64):M.isTexture?Ee("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(w.boundary=16,w.storage=M.byteLength):Ee("WebGLRenderer: Unsupported uniform value type.",M),w}function b(M){let w=M.target;w.removeEventListener("dispose",b);let A=o.indexOf(w.__bindingPointIndex);o.splice(A,1),i.deleteBuffer(s[w.id]),delete s[w.id],delete r[w.id]}function C(){for(let M in s)i.deleteBuffer(s[M]);o=[],s={},r={}}return{bind:h,update:d,dispose:C}}var Gm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),fn=null;function Hm(){return fn===null&&(fn=new Sr(Gm,16,16,Yn,dn),fn.name="DFG_LUT",fn.minFilter=At,fn.magFilter=At,fn.wrapS=rn,fn.wrapT=rn,fn.generateMipmaps=!1,fn.needsUpdate=!0),fn}var Na=class{constructor(e={}){let{canvas:t=Ac(),context:n=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:u=!1,premultipliedAlpha:h=!0,preserveDrawingBuffer:d=!1,powerPreference:a="default",failIfMajorPerformanceCaveat:c=!1,reversedDepthBuffer:l=!1,outputBufferType:f=Ut}=e;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=o;let x=f,p=new Set([$r,Jr,Zr]),g=new Set([Ut,Kt,Bi,zi,qr,Yr]),b=new Uint32Array(4),C=new Int32Array(4),M=new B,w=null,A=null,R=[],v=[],T=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=$t,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let L=this,E=!1,P=null,F=null,k=null,U=null;this._outputColorSpace=zt;let X=0,H=0,J=null,ee=-1,ie=null,re=new rt,se=new rt,Ne=null,Oe=new Le(0),De=0,Z=t.width,te=t.height,j=1,Te=null,Ce=null,we=new rt(0,0,Z,te),st=new rt(0,0,Z,te),Be=!1,qe=new Ii,ke=!1,He=!1,tt=new it,ft=new B,gt=new rt,yt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},at=!1;function ht(){return J===null?j:1}let D=n;function Lt(y,N){return t.getContext(y,N)}try{let y={alpha:!0,depth:s,stencil:r,antialias:u,premultipliedAlpha:h,preserveDrawingBuffer:d,powerPreference:a,failIfMajorPerformanceCaveat:c};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"185"}`),t.addEventListener("webglcontextlost",ot,!1),t.addEventListener("webglcontextrestored",je,!1),t.addEventListener("webglcontextcreationerror",jt,!1),D===null){let N="webgl2";if(D=Lt(N,y),D===null)throw Lt(N)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(y){throw Ie("WebGLRenderer: "+y.message),y}let Je,S,_,O,G,q,ne,oe,Y,K,le,Me,he,ce,Ae,Re,Ue,I,ae,$,ue,me,Q;function ye(){Je=new $f(D),Je.init(),ue=new Fm(D,Je),S=new Gf(D,Je,e,ue),_=new Nm(D,Je),S.reversedDepthBuffer&&l&&_.buffers.depth.setReversed(!0),F=D.createFramebuffer(),k=D.createFramebuffer(),U=D.createFramebuffer(),O=new jf(D),G=new ym,q=new Um(D,Je,_,G,S,ue,O),ne=new Jf(L),oe=new nh(D),me=new Vf(D,oe),Y=new Kf(D,oe,O,me),K=new tp(D,Y,oe,me,O),I=new ep(D,S,q),Ae=new Hf(G),le=new vm(L,ne,Je,S,me,Ae),Me=new Vm(L,G),he=new Sm,ce=new Cm(Je),Ue=new zf(L,ne,_,K,m,h),Re=new Dm(L,K,S),Q=new km(D,O,S,_),ae=new kf(D,Je,O),$=new Qf(D,Je,O),O.programs=le.programs,L.capabilities=S,L.extensions=Je,L.properties=G,L.renderLists=he,L.shadowMap=Re,L.state=_,L.info=O}ye(),x!==Ut&&(T=new ip(x,t.width,t.height,u,s,r));let xe=new cl(L,D);this.xr=xe,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){let y=Je.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){let y=Je.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return j},this.setPixelRatio=function(y){y!==void 0&&(j=y,this.setSize(Z,te,!1))},this.getSize=function(y){return y.set(Z,te)},this.setSize=function(y,N,W=!0){if(xe.isPresenting){Ee("WebGLRenderer: Can't change size while VR device is presenting.");return}Z=y,te=N,t.width=Math.floor(y*j),t.height=Math.floor(N*j),W===!0&&(t.style.width=y+"px",t.style.height=N+"px"),T!==null&&T.setSize(t.width,t.height),this.setViewport(0,0,y,N)},this.getDrawingBufferSize=function(y){return y.set(Z*j,te*j).floor()},this.setDrawingBufferSize=function(y,N,W){Z=y,te=N,j=W,t.width=Math.floor(y*W),t.height=Math.floor(N*W),this.setViewport(0,0,y,N)},this.setEffects=function(y){if(x===Ut){Ie("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let N=0;N<y.length;N++)if(y[N].isOutputPass===!0){Ee("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(re)},this.getViewport=function(y){return y.copy(we)},this.setViewport=function(y,N,W,z){y.isVector4?we.set(y.x,y.y,y.z,y.w):we.set(y,N,W,z),_.viewport(re.copy(we).multiplyScalar(j).round())},this.getScissor=function(y){return y.copy(st)},this.setScissor=function(y,N,W,z){y.isVector4?st.set(y.x,y.y,y.z,y.w):st.set(y,N,W,z),_.scissor(se.copy(st).multiplyScalar(j).round())},this.getScissorTest=function(){return Be},this.setScissorTest=function(y){_.setScissorTest(Be=y)},this.setOpaqueSort=function(y){Te=y},this.setTransparentSort=function(y){Ce=y},this.getClearColor=function(y){return y.copy(Ue.getClearColor())},this.setClearColor=function(){Ue.setClearColor(...arguments)},this.getClearAlpha=function(){return Ue.getClearAlpha()},this.setClearAlpha=function(){Ue.setClearAlpha(...arguments)},this.clear=function(y=!0,N=!0,W=!0){let z=0;if(y){let V=!1;if(J!==null){let pe=J.texture.format;V=p.has(pe)}if(V){let pe=J.texture.type,_e=g.has(pe),fe=Ue.getClearColor(),ve=Ue.getClearAlpha(),Se=fe.r,Fe=fe.g,Ve=fe.b;_e?(b[0]=Se,b[1]=Fe,b[2]=Ve,b[3]=ve,D.clearBufferuiv(D.COLOR,0,b)):(C[0]=Se,C[1]=Fe,C[2]=Ve,C[3]=ve,D.clearBufferiv(D.COLOR,0,C))}else z|=D.COLOR_BUFFER_BIT}N&&(z|=D.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),W&&(z|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z!==0&&D.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),P=y},this.dispose=function(){t.removeEventListener("webglcontextlost",ot,!1),t.removeEventListener("webglcontextrestored",je,!1),t.removeEventListener("webglcontextcreationerror",jt,!1),Ue.dispose(),he.dispose(),ce.dispose(),G.dispose(),ne.dispose(),K.dispose(),me.dispose(),Q.dispose(),le.dispose(),xe.dispose(),xe.removeEventListener("sessionstart",hl),xe.removeEventListener("sessionend",dl),Jn.stop()};function ot(y){y.preventDefault(),Wo("WebGLRenderer: Context Lost."),E=!0}function je(){Wo("WebGLRenderer: Context Restored."),E=!1;let y=O.autoReset,N=Re.enabled,W=Re.autoUpdate,z=Re.needsUpdate,V=Re.type;ye(),O.autoReset=y,Re.enabled=N,Re.autoUpdate=W,Re.needsUpdate=z,Re.type=V}function jt(y){Ie("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function en(y){let N=y.target;N.removeEventListener("dispose",en),ou(N)}function ou(y){lu(y),G.remove(y)}function lu(y){let N=G.get(y).programs;N!==void 0&&(N.forEach(function(W){le.releaseProgram(W)}),y.isShaderMaterial&&le.releaseShaderCache(y))}this.renderBufferDirect=function(y,N,W,z,V,pe){N===null&&(N=yt);let _e=V.isMesh&&V.matrixWorld.determinantAffine()<0,fe=hu(y,N,W,z,V);_.setMaterial(z,_e);let ve=W.index,Se=1;if(z.wireframe===!0){if(ve=Y.getWireframeAttribute(W),ve===void 0)return;Se=2}let Fe=W.drawRange,Ve=W.attributes.position,be=Fe.start*Se,$e=(Fe.start+Fe.count)*Se;pe!==null&&(be=Math.max(be,pe.start*Se),$e=Math.min($e,(pe.start+pe.count)*Se)),ve!==null?(be=Math.max(be,0),$e=Math.min($e,ve.count)):Ve!=null&&(be=Math.max(be,0),$e=Math.min($e,Ve.count));let ct=$e-be;if(ct<0||ct===1/0)return;me.setup(V,z,fe,W,ve);let lt,Ke=ae;if(ve!==null&&(lt=oe.get(ve),Ke=$,Ke.setIndex(lt)),V.isMesh)z.wireframe===!0?(_.setLineWidth(z.wireframeLinewidth*ht()),Ke.setMode(D.LINES)):Ke.setMode(D.TRIANGLES);else if(V.isLine){let Et=z.linewidth;Et===void 0&&(Et=1),_.setLineWidth(Et*ht()),V.isLineSegments?Ke.setMode(D.LINES):V.isLineLoop?Ke.setMode(D.LINE_LOOP):Ke.setMode(D.LINE_STRIP)}else V.isPoints?Ke.setMode(D.POINTS):V.isSprite&&Ke.setMode(D.TRIANGLES);if(V.isBatchedMesh)if(Je.get("WEBGL_multi_draw"))Ke.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{let Et=V._multiDrawStarts,ge=V._multiDrawCounts,Ft=V._multiDrawCount,Ye=ve?oe.get(ve).bytesPerElement:1,Ht=G.get(z).currentProgram.getUniforms();for(let tn=0;tn<Ft;tn++)Ht.setValue(D,"_gl_DrawID",tn),Ke.render(Et[tn]/Ye,ge[tn])}else if(V.isInstancedMesh)Ke.renderInstances(be,ct,V.count);else if(W.isInstancedBufferGeometry){let Et=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,ge=Math.min(W.instanceCount,Et);Ke.renderInstances(be,ct,ge)}else Ke.render(be,ct)};function ul(y,N,W){y.transparent===!0&&y.side===un&&y.forceSinglePass===!1?(y.side=Pt,y.needsUpdate=!0,Is(y,N,W),y.side=bn,y.needsUpdate=!0,Is(y,N,W),y.side=un):Is(y,N,W)}this.compile=function(y,N,W=null){W===null&&(W=y),A=ce.get(W),A.init(N),v.push(A),W.traverseVisible(function(V){V.isLight&&V.layers.test(N.layers)&&(A.pushLight(V),V.castShadow&&A.pushShadow(V))}),y!==W&&y.traverseVisible(function(V){V.isLight&&V.layers.test(N.layers)&&(A.pushLight(V),V.castShadow&&A.pushShadow(V))}),A.setupLights();let z=new Set;return y.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;let pe=V.material;if(pe)if(Array.isArray(pe))for(let _e=0;_e<pe.length;_e++){let fe=pe[_e];ul(fe,W,V),z.add(fe)}else ul(pe,W,V),z.add(pe)}),A=v.pop(),z},this.compileAsync=function(y,N,W=null){let z=this.compile(y,N,W);return new Promise(V=>{function pe(){if(z.forEach(function(_e){G.get(_e).currentProgram.isReady()&&z.delete(_e)}),z.size===0){V(y);return}setTimeout(pe,10)}Je.get("KHR_parallel_shader_compile")!==null?pe():setTimeout(pe,10)})};let za=null;function cu(y){za&&za(y)}function hl(){Jn.stop()}function dl(){Jn.start()}let Jn=new jc;Jn.setAnimationLoop(cu),typeof self<"u"&&Jn.setContext(self),this.setAnimationLoop=function(y){za=y,xe.setAnimationLoop(y),y===null?Jn.stop():Jn.start()},xe.addEventListener("sessionstart",hl),xe.addEventListener("sessionend",dl),this.render=function(y,N){if(N!==void 0&&N.isCamera!==!0){Ie("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;P!==null&&P.renderStart(y,N);let W=xe.enabled===!0&&xe.isPresenting===!0,z=T!==null&&(J===null||W)&&T.begin(L,J);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),xe.enabled===!0&&xe.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(xe.cameraAutoUpdate===!0&&xe.updateCamera(N),N=xe.getCamera()),y.isScene===!0&&y.onBeforeRender(L,y,N,J),A=ce.get(y,v.length),A.init(N),A.state.textureUnits=q.getTextureUnits(),v.push(A),tt.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),qe.setFromProjectionMatrix(tt,Jt,N.reversedDepth),He=this.localClippingEnabled,ke=Ae.init(this.clippingPlanes,He),w=he.get(y,R.length),w.init(),R.push(w),xe.enabled===!0&&xe.isPresenting===!0){let _e=L.xr.getDepthSensingMesh();_e!==null&&Va(_e,N,-1/0,L.sortObjects)}Va(y,N,0,L.sortObjects),w.finish(),L.sortObjects===!0&&w.sort(Te,Ce,N.reversedDepth),at=xe.enabled===!1||xe.isPresenting===!1||xe.hasDepthSensing()===!1,at&&Ue.addToRenderList(w,y),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),ke===!0&&Ae.beginShadows();let V=A.state.shadowsArray;if(Re.render(V,y,N),ke===!0&&Ae.endShadows(),(z&&T.hasRenderPass())===!1){let _e=w.opaque,fe=w.transmissive;if(A.setupLights(),N.isArrayCamera){let ve=N.cameras;if(fe.length>0)for(let Se=0,Fe=ve.length;Se<Fe;Se++){let Ve=ve[Se];pl(_e,fe,y,Ve)}at&&Ue.render(y);for(let Se=0,Fe=ve.length;Se<Fe;Se++){let Ve=ve[Se];fl(w,y,Ve,Ve.viewport)}}else fe.length>0&&pl(_e,fe,y,N),at&&Ue.render(y),fl(w,y,N)}J!==null&&H===0&&(q.updateMultisampleRenderTarget(J),q.updateRenderTargetMipmap(J)),z&&T.end(L),y.isScene===!0&&y.onAfterRender(L,y,N),me.resetDefaultState(),ee=-1,ie=null,v.pop(),v.length>0?(A=v[v.length-1],q.setTextureUnits(A.state.textureUnits),ke===!0&&Ae.setGlobalState(L.clippingPlanes,A.state.camera)):A=null,R.pop(),R.length>0?w=R[R.length-1]:w=null,P!==null&&P.renderEnd()};function Va(y,N,W,z){if(y.visible===!1)return;if(y.layers.test(N.layers)){if(y.isGroup)W=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(N);else if(y.isLightProbeGrid)A.pushLightProbeGrid(y);else if(y.isLight)A.pushLight(y),y.castShadow&&A.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||qe.intersectsSprite(y)){z&&gt.setFromMatrixPosition(y.matrixWorld).applyMatrix4(tt);let _e=K.update(y),fe=y.material;fe.visible&&w.push(y,_e,fe,W,gt.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||qe.intersectsObject(y))){let _e=K.update(y),fe=y.material;if(z&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),gt.copy(y.boundingSphere.center)):(_e.boundingSphere===null&&_e.computeBoundingSphere(),gt.copy(_e.boundingSphere.center)),gt.applyMatrix4(y.matrixWorld).applyMatrix4(tt)),Array.isArray(fe)){let ve=_e.groups;for(let Se=0,Fe=ve.length;Se<Fe;Se++){let Ve=ve[Se],be=fe[Ve.materialIndex];be&&be.visible&&w.push(y,_e,be,W,gt.z,Ve)}}else fe.visible&&w.push(y,_e,fe,W,gt.z,null)}}let pe=y.children;for(let _e=0,fe=pe.length;_e<fe;_e++)Va(pe[_e],N,W,z)}function fl(y,N,W,z){let{opaque:V,transmissive:pe,transparent:_e}=y;A.setupLightsView(W),ke===!0&&Ae.setGlobalState(L.clippingPlanes,W),z&&_.viewport(re.copy(z)),V.length>0&&Rs(V,N,W),pe.length>0&&Rs(pe,N,W),_e.length>0&&Rs(_e,N,W),_.buffers.depth.setTest(!0),_.buffers.depth.setMask(!0),_.buffers.color.setMask(!0),_.setPolygonOffset(!1)}function pl(y,N,W,z){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[z.id]===void 0){let be=Je.has("EXT_color_buffer_half_float")||Je.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[z.id]=new Vt(1,1,{generateMipmaps:!0,type:be?dn:Ut,minFilter:Xn,samples:Math.max(4,S.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ge.workingColorSpace})}let pe=A.state.transmissionRenderTarget[z.id],_e=z.viewport||re;pe.setSize(_e.z*L.transmissionResolutionScale,_e.w*L.transmissionResolutionScale);let fe=L.getRenderTarget(),ve=L.getActiveCubeFace(),Se=L.getActiveMipmapLevel();L.setRenderTarget(pe),L.getClearColor(Oe),De=L.getClearAlpha(),De<1&&L.setClearColor(16777215,.5),L.clear(),at&&Ue.render(W);let Fe=L.toneMapping;L.toneMapping=$t;let Ve=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),A.setupLightsView(z),ke===!0&&Ae.setGlobalState(L.clippingPlanes,z),Rs(y,W,z),q.updateMultisampleRenderTarget(pe),q.updateRenderTargetMipmap(pe),Je.has("WEBGL_multisampled_render_to_texture")===!1){let be=!1;for(let $e=0,ct=N.length;$e<ct;$e++){let lt=N[$e],{object:Ke,geometry:Et,material:ge,group:Ft}=lt;if(ge.side===un&&Ke.layers.test(z.layers)){let Ye=ge.side;ge.side=Pt,ge.needsUpdate=!0,ml(Ke,W,z,Et,ge,Ft),ge.side=Ye,ge.needsUpdate=!0,be=!0}}be===!0&&(q.updateMultisampleRenderTarget(pe),q.updateRenderTargetMipmap(pe))}L.setRenderTarget(fe,ve,Se),L.setClearColor(Oe,De),Ve!==void 0&&(z.viewport=Ve),L.toneMapping=Fe}function Rs(y,N,W){let z=N.isScene===!0?N.overrideMaterial:null;for(let V=0,pe=y.length;V<pe;V++){let _e=y[V],{object:fe,geometry:ve,group:Se}=_e,Fe=_e.material;Fe.allowOverride===!0&&z!==null&&(Fe=z),fe.layers.test(W.layers)&&ml(fe,N,W,ve,Fe,Se)}}function ml(y,N,W,z,V,pe){y.onBeforeRender(L,N,W,z,V,pe),y.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),V.onBeforeRender(L,N,W,z,y,pe),V.transparent===!0&&V.side===un&&V.forceSinglePass===!1?(V.side=Pt,V.needsUpdate=!0,L.renderBufferDirect(W,N,z,V,y,pe),V.side=bn,V.needsUpdate=!0,L.renderBufferDirect(W,N,z,V,y,pe),V.side=un):L.renderBufferDirect(W,N,z,V,y,pe),y.onAfterRender(L,N,W,z,V,pe)}function Is(y,N,W){N.isScene!==!0&&(N=yt);let z=G.get(y),V=A.state.lights,pe=A.state.shadowsArray,_e=V.state.version,fe=le.getParameters(y,V.state,pe,N,W,A.state.lightProbeGridArray),ve=le.getProgramCacheKey(fe),Se=z.programs;z.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?N.environment:null,z.fog=N.fog;let Fe=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;z.envMap=ne.get(y.envMap||z.environment,Fe),z.envMapRotation=z.environment!==null&&y.envMap===null?N.environmentRotation:y.envMapRotation,Se===void 0&&(y.addEventListener("dispose",en),Se=new Map,z.programs=Se);let Ve=Se.get(ve);if(Ve!==void 0){if(z.currentProgram===Ve&&z.lightsStateVersion===_e)return _l(y,fe),Ve}else fe.uniforms=le.getUniforms(y),P!==null&&y.isNodeMaterial&&P.build(y,W,fe),y.onBeforeCompile(fe,L),Ve=le.acquireProgram(fe,ve),Se.set(ve,Ve),z.uniforms=fe.uniforms;let be=z.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(be.clippingPlanes=Ae.uniform),_l(y,fe),z.needsLights=fu(y),z.lightsStateVersion=_e,z.needsLights&&(be.ambientLightColor.value=V.state.ambient,be.lightProbe.value=V.state.probe,be.directionalLights.value=V.state.directional,be.directionalLightShadows.value=V.state.directionalShadow,be.spotLights.value=V.state.spot,be.spotLightShadows.value=V.state.spotShadow,be.rectAreaLights.value=V.state.rectArea,be.ltc_1.value=V.state.rectAreaLTC1,be.ltc_2.value=V.state.rectAreaLTC2,be.pointLights.value=V.state.point,be.pointLightShadows.value=V.state.pointShadow,be.hemisphereLights.value=V.state.hemi,be.directionalShadowMatrix.value=V.state.directionalShadowMatrix,be.spotLightMatrix.value=V.state.spotLightMatrix,be.spotLightMap.value=V.state.spotLightMap,be.pointShadowMatrix.value=V.state.pointShadowMatrix),z.lightProbeGrid=A.state.lightProbeGridArray.length>0,z.currentProgram=Ve,z.uniformsList=null,Ve}function gl(y){if(y.uniformsList===null){let N=y.currentProgram.getUniforms();y.uniformsList=ki.seqWithValue(N.seq,y.uniforms)}return y.uniformsList}function _l(y,N){let W=G.get(y);W.outputColorSpace=N.outputColorSpace,W.batching=N.batching,W.batchingColor=N.batchingColor,W.instancing=N.instancing,W.instancingColor=N.instancingColor,W.instancingMorph=N.instancingMorph,W.skinning=N.skinning,W.morphTargets=N.morphTargets,W.morphNormals=N.morphNormals,W.morphColors=N.morphColors,W.morphTargetsCount=N.morphTargetsCount,W.numClippingPlanes=N.numClippingPlanes,W.numIntersection=N.numClipIntersection,W.vertexAlphas=N.vertexAlphas,W.vertexTangents=N.vertexTangents,W.toneMapping=N.toneMapping}function uu(y,N){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;M.setFromMatrixPosition(N.matrixWorld);for(let W=0,z=y.length;W<z;W++){let V=y[W];if(V.texture!==null&&V.boundingBox.containsPoint(M))return V}return null}function hu(y,N,W,z,V){N.isScene!==!0&&(N=yt),q.resetTextureUnits();let pe=N.fog,_e=z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial?N.environment:null,fe=J===null?L.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:Ge.workingColorSpace,ve=z.isMeshStandardMaterial||z.isMeshLambertMaterial&&!z.envMap||z.isMeshPhongMaterial&&!z.envMap,Se=ne.get(z.envMap||_e,ve),Fe=z.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Ve=!!W.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),be=!!W.morphAttributes.position,$e=!!W.morphAttributes.normal,ct=!!W.morphAttributes.color,lt=$t;z.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(lt=L.toneMapping);let Ke=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Et=Ke!==void 0?Ke.length:0,ge=G.get(z),Ft=A.state.lights;if(ke===!0&&(He===!0||y!==ie)){let et=y===ie&&z.id===ee;Ae.setState(z,y,et)}let Ye=!1;z.version===ge.__version?(ge.needsLights&&ge.lightsStateVersion!==Ft.state.version||ge.outputColorSpace!==fe||V.isBatchedMesh&&ge.batching===!1||!V.isBatchedMesh&&ge.batching===!0||V.isBatchedMesh&&ge.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&ge.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&ge.instancing===!1||!V.isInstancedMesh&&ge.instancing===!0||V.isSkinnedMesh&&ge.skinning===!1||!V.isSkinnedMesh&&ge.skinning===!0||V.isInstancedMesh&&ge.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&ge.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&ge.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&ge.instancingMorph===!1&&V.morphTexture!==null||ge.envMap!==Se||z.fog===!0&&ge.fog!==pe||ge.numClippingPlanes!==void 0&&(ge.numClippingPlanes!==Ae.numPlanes||ge.numIntersection!==Ae.numIntersection)||ge.vertexAlphas!==Fe||ge.vertexTangents!==Ve||ge.morphTargets!==be||ge.morphNormals!==$e||ge.morphColors!==ct||ge.toneMapping!==lt||ge.morphTargetsCount!==Et||!!ge.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(Ye=!0):(Ye=!0,ge.__version=z.version);let Ht=ge.currentProgram;Ye===!0&&(Ht=Is(z,N,V),P&&z.isNodeMaterial&&P.onUpdateProgram(z,Ht,ge));let tn=!1,wn=!1,ui=!1,Qe=Ht.getUniforms(),ut=ge.uniforms;if(_.useProgram(Ht.program)&&(tn=!0,wn=!0,ui=!0),z.id!==ee&&(ee=z.id,wn=!0),ge.needsLights){let et=uu(A.state.lightProbeGridArray,V);ge.lightProbeGrid!==et&&(ge.lightProbeGrid=et,wn=!0)}if(tn||ie!==y){_.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),Qe.setValue(D,"projectionMatrix",y.projectionMatrix),Qe.setValue(D,"viewMatrix",y.matrixWorldInverse);let Rn=Qe.map.cameraPosition;Rn!==void 0&&Rn.setValue(D,ft.setFromMatrixPosition(y.matrixWorld)),S.logarithmicDepthBuffer&&Qe.setValue(D,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&Qe.setValue(D,"isOrthographic",y.isOrthographicCamera===!0),ie!==y&&(ie=y,wn=!0,ui=!0)}if(ge.needsLights&&(Ft.state.directionalShadowMap.length>0&&Qe.setValue(D,"directionalShadowMap",Ft.state.directionalShadowMap,q),Ft.state.spotShadowMap.length>0&&Qe.setValue(D,"spotShadowMap",Ft.state.spotShadowMap,q),Ft.state.pointShadowMap.length>0&&Qe.setValue(D,"pointShadowMap",Ft.state.pointShadowMap,q)),V.isSkinnedMesh){Qe.setOptional(D,V,"bindMatrix"),Qe.setOptional(D,V,"bindMatrixInverse");let et=V.skeleton;et&&(et.boneTexture===null&&et.computeBoneTexture(),Qe.setValue(D,"boneTexture",et.boneTexture,q))}V.isBatchedMesh&&(Qe.setOptional(D,V,"batchingTexture"),Qe.setValue(D,"batchingTexture",V._matricesTexture,q),Qe.setOptional(D,V,"batchingIdTexture"),Qe.setValue(D,"batchingIdTexture",V._indirectTexture,q),Qe.setOptional(D,V,"batchingColorTexture"),V._colorsTexture!==null&&Qe.setValue(D,"batchingColorTexture",V._colorsTexture,q));let Cn=W.morphAttributes;if((Cn.position!==void 0||Cn.normal!==void 0||Cn.color!==void 0)&&I.update(V,W,Ht),(wn||ge.receiveShadow!==V.receiveShadow)&&(ge.receiveShadow=V.receiveShadow,Qe.setValue(D,"receiveShadow",V.receiveShadow)),(z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial)&&z.envMap===null&&N.environment!==null&&(ut.envMapIntensity.value=N.environmentIntensity),ut.dfgLUT!==void 0&&(ut.dfgLUT.value=Hm()),wn){if(Qe.setValue(D,"toneMappingExposure",L.toneMappingExposure),ge.needsLights&&du(ut,ui),pe&&z.fog===!0&&Me.refreshFogUniforms(ut,pe),Me.refreshMaterialUniforms(ut,z,j,te,A.state.transmissionRenderTarget[y.id]),ge.needsLights&&ge.lightProbeGrid){let et=ge.lightProbeGrid;ut.probesSH.value=et.texture,ut.probesMin.value.copy(et.boundingBox.min),ut.probesMax.value.copy(et.boundingBox.max),ut.probesResolution.value.copy(et.resolution)}ki.upload(D,gl(ge),ut,q)}if(z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(ki.upload(D,gl(ge),ut,q),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&Qe.setValue(D,"center",V.center),Qe.setValue(D,"modelViewMatrix",V.modelViewMatrix),Qe.setValue(D,"normalMatrix",V.normalMatrix),Qe.setValue(D,"modelMatrix",V.matrixWorld),z.uniformsGroups!==void 0){let et=z.uniformsGroups;for(let Rn=0,hi=et.length;Rn<hi;Rn++){let xl=et[Rn];Q.update(xl,Ht),Q.bind(xl,Ht)}}return Ht}function du(y,N){y.ambientLightColor.needsUpdate=N,y.lightProbe.needsUpdate=N,y.directionalLights.needsUpdate=N,y.directionalLightShadows.needsUpdate=N,y.pointLights.needsUpdate=N,y.pointLightShadows.needsUpdate=N,y.spotLights.needsUpdate=N,y.spotLightShadows.needsUpdate=N,y.rectAreaLights.needsUpdate=N,y.hemisphereLights.needsUpdate=N}function fu(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return X},this.getActiveMipmapLevel=function(){return H},this.getRenderTarget=function(){return J},this.setRenderTargetTextures=function(y,N,W){let z=G.get(y);z.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),G.get(y.texture).__webglTexture=N,G.get(y.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:W,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,N){let W=G.get(y);W.__webglFramebuffer=N,W.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(y,N=0,W=0){J=y,X=N,H=W;let z=null,V=!1,pe=!1;if(y){let fe=G.get(y);if(fe.__useDefaultFramebuffer!==void 0){_.bindFramebuffer(D.FRAMEBUFFER,fe.__webglFramebuffer),re.copy(y.viewport),se.copy(y.scissor),Ne=y.scissorTest,_.viewport(re),_.scissor(se),_.setScissorTest(Ne),ee=-1;return}else if(fe.__webglFramebuffer===void 0)q.setupRenderTarget(y);else if(fe.__hasExternalTextures)q.rebindTextures(y,G.get(y.texture).__webglTexture,G.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){let Fe=y.depthTexture;if(fe.__boundDepthTexture!==Fe){if(Fe!==null&&G.has(Fe)&&(y.width!==Fe.image.width||y.height!==Fe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");q.setupDepthRenderbuffer(y)}}let ve=y.texture;(ve.isData3DTexture||ve.isDataArrayTexture||ve.isCompressedArrayTexture)&&(pe=!0);let Se=G.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Se[N])?z=Se[N][W]:z=Se[N],V=!0):y.samples>0&&q.useMultisampledRTT(y)===!1?z=G.get(y).__webglMultisampledFramebuffer:Array.isArray(Se)?z=Se[W]:z=Se,re.copy(y.viewport),se.copy(y.scissor),Ne=y.scissorTest}else re.copy(we).multiplyScalar(j).floor(),se.copy(st).multiplyScalar(j).floor(),Ne=Be;if(W!==0&&(z=F),_.bindFramebuffer(D.FRAMEBUFFER,z)&&_.drawBuffers(y,z),_.viewport(re),_.scissor(se),_.setScissorTest(Ne),V){let fe=G.get(y.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+N,fe.__webglTexture,W)}else if(pe){let fe=N;for(let ve=0;ve<y.textures.length;ve++){let Se=G.get(y.textures[ve]);D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0+ve,Se.__webglTexture,W,fe)}}else if(y!==null&&W!==0){let fe=G.get(y.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,fe.__webglTexture,W)}ee=-1},this.readRenderTargetPixels=function(y,N,W,z,V,pe,_e,fe=0){if(!(y&&y.isWebGLRenderTarget)){Ie("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=G.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&_e!==void 0&&(ve=ve[_e]),ve){_.bindFramebuffer(D.FRAMEBUFFER,ve);try{let Se=y.textures[fe],Fe=Se.format,Ve=Se.type;if(y.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+fe),!S.textureFormatReadable(Fe)){Ie("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!S.textureTypeReadable(Ve)){Ie("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=y.width-z&&W>=0&&W<=y.height-V&&D.readPixels(N,W,z,V,ue.convert(Fe),ue.convert(Ve),pe)}finally{let Se=J!==null?G.get(J).__webglFramebuffer:null;_.bindFramebuffer(D.FRAMEBUFFER,Se)}}},this.readRenderTargetPixelsAsync=async function(y,N,W,z,V,pe,_e,fe=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=G.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&_e!==void 0&&(ve=ve[_e]),ve)if(N>=0&&N<=y.width-z&&W>=0&&W<=y.height-V){_.bindFramebuffer(D.FRAMEBUFFER,ve);let Se=y.textures[fe],Fe=Se.format,Ve=Se.type;if(y.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+fe),!S.textureFormatReadable(Fe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!S.textureTypeReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let be=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,be),D.bufferData(D.PIXEL_PACK_BUFFER,pe.byteLength,D.STREAM_READ),D.readPixels(N,W,z,V,ue.convert(Fe),ue.convert(Ve),0);let $e=J!==null?G.get(J).__webglFramebuffer:null;_.bindFramebuffer(D.FRAMEBUFFER,$e);let ct=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await Ec(D,ct,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,be),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,pe),D.deleteBuffer(be),D.deleteSync(ct),pe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,N=null,W=0){let z=Math.pow(2,-W),V=Math.floor(y.image.width*z),pe=Math.floor(y.image.height*z),_e=N!==null?N.x:0,fe=N!==null?N.y:0;q.setTexture2D(y,0),D.copyTexSubImage2D(D.TEXTURE_2D,W,0,0,_e,fe,V,pe),_.unbindTexture()},this.copyTextureToTexture=function(y,N,W=null,z=null,V=0,pe=0){let _e,fe,ve,Se,Fe,Ve,be,$e,ct,lt=y.isCompressedTexture?y.mipmaps[pe]:y.image;if(W!==null)_e=W.max.x-W.min.x,fe=W.max.y-W.min.y,ve=W.isBox3?W.max.z-W.min.z:1,Se=W.min.x,Fe=W.min.y,Ve=W.isBox3?W.min.z:0;else{let ut=Math.pow(2,-V);_e=Math.floor(lt.width*ut),fe=Math.floor(lt.height*ut),y.isDataArrayTexture?ve=lt.depth:y.isData3DTexture?ve=Math.floor(lt.depth*ut):ve=1,Se=0,Fe=0,Ve=0}z!==null?(be=z.x,$e=z.y,ct=z.z):(be=0,$e=0,ct=0);let Ke=ue.convert(N.format),Et=ue.convert(N.type),ge;N.isData3DTexture?(q.setTexture3D(N,0),ge=D.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(q.setTexture2DArray(N,0),ge=D.TEXTURE_2D_ARRAY):(q.setTexture2D(N,0),ge=D.TEXTURE_2D),_.activeTexture(D.TEXTURE0),_.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,N.flipY),_.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),_.pixelStorei(D.UNPACK_ALIGNMENT,N.unpackAlignment);let Ft=_.getParameter(D.UNPACK_ROW_LENGTH),Ye=_.getParameter(D.UNPACK_IMAGE_HEIGHT),Ht=_.getParameter(D.UNPACK_SKIP_PIXELS),tn=_.getParameter(D.UNPACK_SKIP_ROWS),wn=_.getParameter(D.UNPACK_SKIP_IMAGES);_.pixelStorei(D.UNPACK_ROW_LENGTH,lt.width),_.pixelStorei(D.UNPACK_IMAGE_HEIGHT,lt.height),_.pixelStorei(D.UNPACK_SKIP_PIXELS,Se),_.pixelStorei(D.UNPACK_SKIP_ROWS,Fe),_.pixelStorei(D.UNPACK_SKIP_IMAGES,Ve);let ui=y.isDataArrayTexture||y.isData3DTexture,Qe=N.isDataArrayTexture||N.isData3DTexture;if(y.isDepthTexture){let ut=G.get(y),Cn=G.get(N),et=G.get(ut.__renderTarget),Rn=G.get(Cn.__renderTarget);_.bindFramebuffer(D.READ_FRAMEBUFFER,et.__webglFramebuffer),_.bindFramebuffer(D.DRAW_FRAMEBUFFER,Rn.__webglFramebuffer);for(let hi=0;hi<ve;hi++)ui&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,G.get(y).__webglTexture,V,Ve+hi),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,G.get(N).__webglTexture,pe,ct+hi)),D.blitFramebuffer(Se,Fe,_e,fe,be,$e,_e,fe,D.DEPTH_BUFFER_BIT,D.NEAREST);_.bindFramebuffer(D.READ_FRAMEBUFFER,null),_.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(V!==0||y.isRenderTargetTexture||G.has(y)){let ut=G.get(y),Cn=G.get(N);_.bindFramebuffer(D.READ_FRAMEBUFFER,k),_.bindFramebuffer(D.DRAW_FRAMEBUFFER,U);for(let et=0;et<ve;et++)ui?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,ut.__webglTexture,V,Ve+et):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ut.__webglTexture,V),Qe?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Cn.__webglTexture,pe,ct+et):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,Cn.__webglTexture,pe),V!==0?D.blitFramebuffer(Se,Fe,_e,fe,be,$e,_e,fe,D.COLOR_BUFFER_BIT,D.NEAREST):Qe?D.copyTexSubImage3D(ge,pe,be,$e,ct+et,Se,Fe,_e,fe):D.copyTexSubImage2D(ge,pe,be,$e,Se,Fe,_e,fe);_.bindFramebuffer(D.READ_FRAMEBUFFER,null),_.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else Qe?y.isDataTexture||y.isData3DTexture?D.texSubImage3D(ge,pe,be,$e,ct,_e,fe,ve,Ke,Et,lt.data):N.isCompressedArrayTexture?D.compressedTexSubImage3D(ge,pe,be,$e,ct,_e,fe,ve,Ke,lt.data):D.texSubImage3D(ge,pe,be,$e,ct,_e,fe,ve,Ke,Et,lt):y.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,pe,be,$e,_e,fe,Ke,Et,lt.data):y.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,pe,be,$e,lt.width,lt.height,Ke,lt.data):D.texSubImage2D(D.TEXTURE_2D,pe,be,$e,_e,fe,Ke,Et,lt);_.pixelStorei(D.UNPACK_ROW_LENGTH,Ft),_.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Ye),_.pixelStorei(D.UNPACK_SKIP_PIXELS,Ht),_.pixelStorei(D.UNPACK_SKIP_ROWS,tn),_.pixelStorei(D.UNPACK_SKIP_IMAGES,wn),pe===0&&N.generateMipmaps&&D.generateMipmap(ge),_.unbindTexture()},this.initRenderTarget=function(y){G.get(y).__webglFramebuffer===void 0&&q.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?q.setTextureCube(y,0):y.isData3DTexture?q.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?q.setTexture2DArray(y,0):q.setTexture2D(y,0),_.unbindTexture()},this.resetState=function(){X=0,H=0,J=null,_.reset(),me.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Jt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Ge._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ge._getUnpackColorSpace()}};var Ba=Mu(au());(function(){"use strict";var i=window.matchMedia("(prefers-reduced-motion: reduce)").matches,e=window.matchMedia("(pointer: coarse)").matches,t=window.gsap,n=window.ScrollTrigger;t&&n&&t.registerPlugin(n);var s=15901240,r=1795249,o=2782660,u=15659767,h=!1,d={},a=window.CM_SOUNDS||{},c=document.getElementById("soundToggle");function l(){d.whoosh||!a.whoosh||(d.whoosh=new Ba.Howl({src:[a.whoosh],volume:.16}),d.tick=new Ba.Howl({src:[a.tick],volume:.22}),d.pop=new Ba.Howl({src:[a.pop],volume:.2}))}function f(E){h&&d[E]&&d[E].play()}function m(E){h=E,E&&l(),c&&(c.classList.toggle("is-on",E),c.setAttribute("aria-pressed",E?"true":"false"),c.setAttribute("aria-label",E?"Desativar sons do site":"Ativar sons do site"));try{localStorage.setItem("cm-sound",E?"1":"0")}catch{}E&&f("pop")}c&&c.addEventListener("click",function(){m(!h)});try{if(localStorage.getItem("cm-sound")==="1"){var x=function(){m(!0),document.removeEventListener("pointerdown",x)};document.addEventListener("pointerdown",x)}}catch{}var p=0;function g(){var E=Date.now();E-p>800&&(p=E,f("whoosh"))}n&&document.querySelectorAll("main > section[id]").forEach(function(E){n.create({trigger:E,start:"top 55%",onEnter:g,onEnterBack:g})}),document.addEventListener("click",function(E){E.target.closest(".chip")||E.target.closest(".dep-card")?f("tick"):E.target.closest(".faq-item summary")?f("pop"):E.target.closest(".btn")&&f("tick")});var b=[];function C(E,P){if(!E||!P||i)return null;var F;try{F=new Na({canvas:E,alpha:!0,antialias:!0,powerPreference:"low-power"})}catch{return null}F.setPixelRatio(Math.min(window.devicePixelRatio||1,1.75));var k={renderer:F,scene:new ns,camera:new Mt(55,1,.1,200),section:P,visible:!0,scroll:{p:0},update:null};function U(){var X=P.clientWidth,H=P.clientHeight;F.setSize(X,H,!1),k.camera.aspect=X/H,k.camera.updateProjectionMatrix()}return window.addEventListener("resize",U),U(),"IntersectionObserver"in window&&new IntersectionObserver(function(X){k.visible=X[0].isIntersecting},{threshold:0}).observe(P),t&&n&&t.to(k.scroll,{p:1,ease:"none",scrollTrigger:{trigger:P,start:"top bottom",end:"bottom top",scrub:.6}}),b.push(k),k}if((function(){var P=document.getElementById("inicio"),F=C(document.getElementById("heroCanvas"),P);if(F){P.classList.add("has-3d");var k=F.scene,U=F.camera;U.position.set(0,0,14),k.add(new fs(16777215,.6));var X=new ds(16770756,1.4);X.position.set(6,9,7),k.add(X);var H=new hs(s,30,40);H.position.set(-7,-4,3),k.add(H);for(var J=[s,s,r,o,u],ee=new Mn,ie=[],re=new Vn(1.6,.75,.9),se=new os(re),Ne=0;Ne<38;Ne++){var Oe;Ne%6===5?Oe=new Li(se,new zn({color:s,transparent:!0,opacity:.55})):Oe=new It(re,new ls({color:J[Ne%J.length],roughness:.55,metalness:.15}));var De=Math.pow(Math.random(),.6),Z=new B((Math.random()-.5)*24*De,(Math.random()-.5)*13*De,(Math.random()-.5)*12-2);Oe.position.copy(Z),Oe.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),Oe.scale.setScalar(.5+Math.random()*.9),Oe.userData={base:Z,start:Z.clone().add(new B((Math.random()-.5)*40,(Math.random()-.5)*30,-30-Math.random()*20)),phase:Math.random()*Math.PI*2,bobSpeed:.3+Math.random()*.5,spinX:(Math.random()-.5)*.25,spinY:(Math.random()-.5)*.35},ie.push(Oe),ee.add(Oe)}k.add(ee);var te=new ms(80,40,s,o);te.material.transparent=!0,te.material.opacity=.16,te.position.y=-8,k.add(te);var j={x:0,y:0};window.addEventListener("pointermove",function(Ce){j.x=Ce.clientX/window.innerWidth*2-1,j.y=Ce.clientY/window.innerHeight*2-1},{passive:!0});var Te=performance.now();F.update=function(Ce){for(var we=Math.min((performance.now()-Te)/2e3,1),st=1-Math.pow(1-we,3),Be=0;Be<ie.length;Be++){var qe=ie[Be],ke=qe.userData,He=Math.sin(Ce*ke.bobSpeed+ke.phase)*.45;qe.position.lerpVectors(ke.start,ke.base,st),qe.position.y+=He*st,qe.rotation.x+=ke.spinX*.016,qe.rotation.y+=ke.spinY*.016}ee.rotation.y=Ce*.04+j.x*.12,ee.rotation.x=j.y*.08;var tt=Math.max(0,F.scroll.p*2-1);U.position.z=14-tt*7,U.position.y=-tt*4.5,U.rotation.z=tt*.12,U.lookAt(0,-tt*3,0)}}})(),(function(){var P=document.getElementById("diferenciais"),F=C(document.getElementById("fxDiferenciais"),P);if(F){var k=F.scene,U=F.camera;U.position.set(0,0,16);for(var X=900,H=new Float32Array(X*3),J=new Float32Array(X*3),ee=new Le(s),ie=new Le(o),re=new Le(14674421),se=0;se<X;se++){H[se*3]=(Math.random()-.5)*46,H[se*3+1]=(Math.random()-.5)*24,H[se*3+2]=(Math.random()-.5)*22;var Ne=Math.random()<.28?ee:Math.random()<.7?ie:re;J[se*3]=Ne.r,J[se*3+1]=Ne.g,J[se*3+2]=Ne.b}var Oe=new vt;Oe.setAttribute("position",new St(H,3)),Oe.setAttribute("color",new St(J,3));var De=new Di(Oe,new ri({size:.14,vertexColors:!0,transparent:!0,opacity:.85,blending:Oi,depthWrite:!1,sizeAttenuation:!0}));k.add(De);for(var Z=new zn({color:r,transparent:!0,opacity:.25}),te=0;te<5;te++){var j=new vt().setFromPoints([new B(-30,-8+te*4,-8),new B(30,-8+te*4,-8)]);k.add(new Pi(j,Z))}F.update=function(Te){De.rotation.y=Te*.03,De.rotation.x=Math.sin(Te*.11)*.06,U.position.z=20-F.scroll.p*9,U.position.y=(F.scroll.p-.5)*3,U.lookAt(0,0,0)}}})(),(function(){var P=document.getElementById("contato"),F=C(document.getElementById("fxContato"),P);if(F){var k=F.scene,U=F.camera;U.position.set(0,3.2,16),k.fog=new ts(729920,12,46);var X=70,H=44,J=46,ee=30,ie=new ai(X,H,J,ee);ie.rotateX(-Math.PI/2);var re=new It(ie,new si({color:o,wireframe:!0,transparent:!0,opacity:.33}));re.position.y=-2.5,k.add(re);for(var se=ie.attributes.position,Ne=140,Oe=new Float32Array(Ne*3),De=0;De<Ne;De++)Oe[De*3]=(Math.random()-.5)*60,Oe[De*3+1]=2+Math.random()*12,Oe[De*3+2]=-Math.random()*40;var Z=new vt;Z.setAttribute("position",new St(Oe,3)),k.add(new Di(Z,new ri({color:s,size:.16,transparent:!0,opacity:.8,blending:Oi,depthWrite:!1}))),F.update=function(te){for(var j=0;j<se.count;j++){var Te=se.getX(j),Ce=se.getZ(j);se.setY(j,Math.sin(Te*.32+te*.7)*Math.cos(Ce*.22+te*.55)*1.15)}se.needsUpdate=!0,U.position.y=3.2-F.scroll.p*1.2,U.position.x=Math.sin(te*.08)*1.4,U.lookAt(0,.6,-12)}}})(),b.length){var M=new ps;(function E(){if(requestAnimationFrame(E),!document.hidden)for(var P=M.getElapsedTime(),F=0;F<b.length;F++){var k=b[F];k.visible&&(k.update&&k.update(P),k.renderer.render(k.scene,k.camera))}})()}if(t&&!i){var w=document.querySelector(".hero-title");if(w){for(var A=document.createTreeWalker(w,NodeFilter.SHOW_TEXT),R=[];A.nextNode();)R.push(A.currentNode);R.forEach(function(E){var P=document.createDocumentFragment();E.textContent.split(/(\s+)/).forEach(function(F){if(F){if(/^\s+$/.test(F)){P.appendChild(document.createTextNode(F));return}var k=document.createElement("span");k.className="w";var U=document.createElement("span");U.className="wi",U.textContent=F,k.appendChild(U),P.appendChild(k)}}),E.parentNode.replaceChild(P,E)}),t.set(".hero-title .wi",{yPercent:120,rotate:6});var v=t.timeline({defaults:{ease:"power4.out"}});v.to(".hero-title .wi",{yPercent:0,rotate:0,duration:1.1,stagger:.07},.15).from(".hero-badge",{y:-18,autoAlpha:0,duration:.7},.1).from(".hero-sub",{y:24,autoAlpha:0,duration:.8},.7).from(".hero-ctas .btn",{y:24,autoAlpha:0,duration:.7,stagger:.1},.9).from(".hero-stats .stat",{y:24,autoAlpha:0,duration:.7,stagger:.08},1.05),document.querySelectorAll(".hero .reveal").forEach(function(E){E.classList.add("is-in"),E.style.transition="none"})}if(n){t.to(".hero-inner",{yPercent:-14,autoAlpha:.25,ease:"none",scrollTrigger:{trigger:"#inicio",start:"top top",end:"bottom top",scrub:!0}});var T=document.getElementById("header");n.create({start:"top -120",onUpdate:function(E){E.direction===1&&E.scroll()>300?T.classList.add("is-hidden"):T.classList.remove("is-hidden")}}),t.utils.toArray(".about-card").forEach(function(E,P){E.style.transition="box-shadow .3s ease",t.from(E,{x:P%2?60:-60,autoAlpha:0,duration:.9,ease:"power3.out",scrollTrigger:{trigger:E,start:"top 85%"}})}),t.from(".quote-box",{scale:.94,autoAlpha:0,duration:.9,ease:"power3.out",scrollTrigger:{trigger:".quote-box",start:"top 80%"}});var L=document.getElementById("showcaseImg");L&&(t.fromTo(L,{yPercent:-10},{yPercent:10,ease:"none",scrollTrigger:{trigger:".showcase",start:"top bottom",end:"bottom top",scrub:!0}}),t.from(".showcase-content > *",{y:40,autoAlpha:0,duration:.9,stagger:.12,ease:"power3.out",scrollTrigger:{trigger:".showcase",start:"top 65%"}})),t.utils.toArray(".store-photo img").forEach(function(E){t.from(E,{scale:1.18,duration:1.2,ease:"power2.out",clearProps:"transform",scrollTrigger:{trigger:E,start:"top 90%"}})})}}!i&&!e&&(document.querySelectorAll(".btn-primary, .btn-whats, .btn-outline").forEach(function(E){E.addEventListener("pointermove",function(P){var F=E.getBoundingClientRect(),k=(P.clientX-F.left-F.width/2)/F.width,U=(P.clientY-F.top-F.height/2)/F.height;E.style.transform="translate("+k*7+"px,"+(U*7-2)+"px)"}),E.addEventListener("pointerleave",function(){E.style.transform=""})}),document.querySelectorAll(".dep-card, .store-card, .feat").forEach(function(E){E.addEventListener("pointermove",function(P){var F=E.getBoundingClientRect(),k=((P.clientY-F.top)/F.height-.5)*-7,U=((P.clientX-F.left)/F.width-.5)*7;E.style.transform="perspective(800px) translateY(-6px) rotateX("+k+"deg) rotateY("+U+"deg)"}),E.addEventListener("pointerleave",function(){E.style.transform=""})}))})();})();
